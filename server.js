...
app.use('/api/system', require('./routes/systemConfig'));   // /public-config, /system-settings
app.use('/api/system', require('./routes/systemHealth'));   // /health-check (non-overlapping paths)
