                      ...
                      <td style="padding: 12px 16px; text-align: center;">
                        <div class="btn-icon-group justify-content-center">
                          ${o.status!=="assigned"&&o.status!=="cancelled"?`
                            ...
                            <button type="button" class="btn-icon-action action-delete btn-cancel-waiting" data-id="${o._id}" data-tooltip="Cancel Waiting Entry" aria-label="Cancel">\u2715</button>
