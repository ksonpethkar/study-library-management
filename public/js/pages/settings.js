import C from"../api.js";import{Toast as S,Modal as V,Confirm as ee,Loading as O,escapeHTML as u}from"../ui.js";import{MediaFieldPicker as U}from"../mediaStudio.js";import"../i18n.js";import"../pdfGenerator.js";import{FormBuilder as K}from"../formBuilder.js";import"../utils/pushNotifications.js";import{render as te}from"./trash.js";async function G(e){e||(e=document.createElement("div"),e.className="page-container"),e.innerHTML=`
  ...
  `;try{const[m,o,v,a,s]=await Promise.allSettled([C.get("/api/settings"),C.get("/api/branches"),C.get("/api/plans"),C.get("/api/shifts"),C.get("/api/auth/users").catch(()=>({data:[]}))]),i=m.status==="fulfilled"&&m.value?.data?m.value.data:{},r=i.businessProfile||{},b=i.systemSettings||{},n=o.status==="fulfilled"&&Array.isArray(o.value?.data)?o.value.data:[],l=v.status==="fulfilled"&&Array.isArray(v.value?.data)?v.value.data:[],f=a.status==="fulfilled"&&Array.isArray(a.value?.data)?a.value.data:[],E=s.status==="fulfilled"&&Array.isArray(s.value?.data)?s.value.data:[],$=b.general||{},k=b.payment||{},I=b.admission||{},D=b.notification||{},H=b.portal||{},z=b.automations||{},x=b.billing||{},t=b.operations||{};ae(e,{profile:r,settings:{gen:$,pay:k,adm:I,notif:D,portal:H,auto:z,billing:x,ops:t},branches:n,plans:l,shifts:f,staffUsers:E})}catch(m){console.error("Failed to load Master Settings Hub:",m),e.innerHTML=`
    ...
    `,e.querySelector("#btn-retry-settings")?.addEventListener("click",()=>G())}return e}function ae(e,m){const{profile:o,settings:v,branches:a,plans:s,shifts:i,staffUsers:r}=m,{gen:b,pay:n,adm:l,notif:f,portal:E,auto:$,billing:k,ops:I}=v;e.innerHTML=`
    <!-- Top Action Bar -->
  ...
  `,setTimeout(()=>{const v=o.querySelector("#mount-branding-logo");if(v&&typeof U<"u"){const r=U.create({name:"logo",label:"Official Library Logo",value:e.logo||"",preset:"stamp_logo",onChange:b=>{e.logo=b}});r.querySelector(".mfp-hidden-value")?.setAttribute("id","setting-logo"),v.appendChild(r)}const a=o.querySelector("#mount-branding-favicon");if(a&&typeof U<"u"){const r=U.create({name:"favicon",label:"Browser Favicon / App Icon",value:e.favicon||"",preset:"stamp_logo",onChange:b=>{e.favicon=b}});r.querySelector(".mfp-hidden-value")?.setAttribute("id","setting-favicon"),a.appendChild(r)}const s=o.querySelector("#mount-branding-stamp");if(s&&typeof U<"u"){const r=U.create({name:"stampImage",label:"Official Digital Stamp / Seal",value:e.stampImage||"",preset:"stamp_logo",onChange:b=>{e.stampImage=b}});r.querySelector(".mfp-hidden-value")?.setAttribute("id","setting-stamp"),s.appendChild(r)}const i=o.querySelector("#mount-branding-banner");if(i&&typeof U<"u"){const r=U.create({name:"bannerImage",label:"Organisation Banner / Hero Cover",value:e.bannerImage||"",preset:"cover_banner",onChange:b=>{e.bannerImage=b}});r.querySelector(".mfp-hidden-value")?.setAttribute("id","setting-banner"),i.appendChild(r)}},10),o}function se(e,m,o,v){const a=v?.settings?.locker||{},s=v?.profile||{},i=Array.isArray(s.paymentMethods)?s.paymentMethods:[],r=new Map(i.map(n=>[n.key,n])),b=[{key:"upi",name:"Dynamic UPI QR & 1-Tap Apps",subtitle:"GPay / PhonePe / Paytm / BHIM (Instant)",icon:"\u26A1",defaultEnabled:!0,instructions:"Scan QR code or use 1-tap UPI app buttons and enter 12-digit UTR number",refLabel:"12-Digit Bank UTR / Reference Number *",requiresRef:!0},{key:"card",name:"Debit / Credit Card",subtitle:"Visa, Mastercard, RuPay & POS Swipe",icon:"\u{1F4B3}",defaultEnabled:!0,instructions:"Swipe / pay via card machine or online POS and enter card txn reference",refLabel:"Card Transaction Reference / Approval Code *",requiresRef:!0},{key:"netbanking",name:"NetBanking / Direct Bank Transfer",subtitle:"NEFT / IMPS / RTGS (All Indian Banks)",icon:"\u{1F3E6}",defaultEnabled:!0,instructions:"Transfer fee to official library bank account and enter transaction UTR or upload slip",refLabel:"Bank Transaction Reference / UTR *",requiresRef:!0},{key:"desk",name:"Pay Later at Front Desk",subtitle:"Cash / Spot Pay on Arrival",icon:"\u{1F4B5}",defaultEnabled:!0,instructions:"Your chosen seat is reserved for 24 hours. Pay cash or UPI at the front desk upon arrival.",refLabel:"",requiresRef:!1}].map(n=>{const l=r.get(n.key),f=l?l.enabled!==!1:n.defaultEnabled,E=l?.name||n.name,$=l?.subtitle||n.subtitle,k=l?.instructions||n.instructions,I=l?.requiresRef!==void 0?l.requiresRef:n.requiresRef,D=l?.refLabel||n.refLabel;return`
      <div class="setting-paymethod-row card p-3" data-key="${n.key}" data-name="${u(E)}" data-icon="${n.icon}" style="background: var(--color-bg-secondary); border: 1px solid var(--color-border); border-radius: var(--radius-md); transition: all 0.2s;">
        ...
        <div class="row g-2 mt-1">
          ...
          <div class="col-md-4">
            ...
            <input type="text" class="form-control form-control-sm spm-reflabel" value="${u(D)}" placeholder="e.g. UTR / Ref *">
          </div>
        </div>
      </div>
    `}).join("");return`
    <div class="card" style="padding: 1.5rem; background: var(--color-surface); border: 1px solid var(--color-border); border-radius: var(--radius-lg);">
      ...
      <div class="card settings-accordion-card">
        <div class="settings-accordion-header">
          <h5><span>\u{1F4CB}</span> Active Membership Plans Overview (${o.length} Plans)</h5>
          <span class="settings-accordion-toggle">\u25B2</span>
        </div>
        <div class="settings-accordion-body">
          <div class="table-responsive">
            <table class="table" style="font-size: 0.88rem;">
              ...
              <tbody>
                ${o.length>0?o.map(n=>{const l=Number(n.price||0),f=Number(n.discount||0),E=Math.round(n.effectivePrice!==void 0?n.effectivePrice:l*(1-f/100));return`
                  <tr>
  ...
  `,setTimeout(async()=>{const o=m.querySelector("#form-builder-mount-container");if(o&&typeof K<"u")try{await K.render(o)}catch(v){console.error("Form builder render error:",v),o.innerHTML=`<div class="p-4 text-center text-muted">Error loading Form Builder studio: ${u(v.message)}</div>`}},50),m}function ie(e,m){return`
    <div class="card" style="padding: 1.5rem; background: var(--color-surface); border: 1px solid var(--color-border); border-radius: var(--radius-lg);">
      <div style="border-bottom: 1px solid var(--color-border); padding-bottom: 12px; margin-bottom: 1.25rem; display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 8px;">
        <div>
              ...
              <tbody>
                ${e.length>0?e.map(o=>`
                  <tr>
                    ...
                    <td><code>${u(o.code||"MAIN")}</code></td>
                    <td>${u(o.city||"Central")}</td>
                    <td><strong>${o.totalSeats||50} Desks</strong></td>
                    <td>${u(o.phone||"-")}</td>
            ...
            <table class="table" style="font-size: 0.88rem;">
              ...
              <tbody>
                ${m.length>0?m.map(o=>`
                  <tr>
                    <td><strong>${u(o.name)}</strong></td>
                    <td><code>${u(o.code||"-")}</code></td>
                    <td>${o.startTime||"06:00"} \u2013 ${o.endTime||"23:00"}</td>
                    <td><span class="badge" style="background: rgba(108,92,231,0.15); color: var(--color-primary);">${o.priceMultiplier||1}x</span></td>
                    <td>${o.maxCapacity>0?`${o.maxCapacity} seats`:"Unlimited"}</td>
                    <td><span class="badge badge-success">Active</span></td>
                  </tr>
  ...
  `}function le(e,m,o,v){const a=document.createElement("div");a.className="card",a.style.cssText="padding: 1.5rem; background: var(--color-surface); border: 1px solid var(--color-border); border-radius: var(--radius-lg);";let s=m["billing.defaultTemplate"]||"thermal80";return a.innerHTML=`
    <div style="border-bottom: 1px solid var(--color-border); padding-bottom: 12px; margin-bottom: 1.25rem; display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 8px;">
      <div>
    ...
    <div style="margin-bottom: 1.5rem;">
      ...
      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(180px, 1fr)); gap: 12px;" id="receipt-format-grid">
        <div class="card p-3 receipt-format-card ${s==="thermal80"?"active":""}" data-format="thermal80" style="border: ${s==="thermal80"?"2px solid var(--color-primary)":"1px solid var(--color-border)"}; background: var(--color-surface); text-align: center; cursor: pointer; transition: all 0.2s; border-radius: var(--radius-md);">
        ...
        <div class="card p-3 receipt-format-card ${s==="thermal58"?"active":""}" data-format="thermal58" style="border: ${s==="thermal58"?"2px solid var(--color-primary)":"1px solid var(--color-border)"}; background: var(--color-surface); text-align: center; cursor: pointer; transition: all 0.2s; border-radius: var(--radius-md);">
        ...
        <div class="card p-3 receipt-format-card ${s==="standardA4"?"active":""}" data-format="standardA4" style="border: ${s==="standardA4"?"2px solid var(--color-primary)":"1px solid var(--color-border)"}; background: var(--color-surface); text-align: center; cursor: pointer; transition: all 0.2s; border-radius: var(--radius-md);">
        ...
        <div class="card p-3 receipt-format-card ${s==="modern_minimal"?"active":""}" data-format="modern_minimal" style="border: ${s==="modern_minimal"?"2px solid var(--color-primary)":"1px solid var(--color-border)"}; background: var(--color-surface); text-align: center; cursor: pointer; transition: all 0.2s; border-radius: var(--radius-md);">
  ...
  `,setTimeout(async()=>{try{const n=await C.get("/api/settings/receipt-config");if(n.success&&n.data){const l=n.data;l.activeTemplate&&(s=l.activeTemplate,a.querySelectorAll(".receipt-format-card").forEach(f=>{f.dataset.format===s?(f.classList.add("active"),f.style.border="2px solid var(--color-primary)"):(f.classList.remove("active"),f.style.border="1px solid var(--color-border)")})),l.header?.subtitle&&(a.querySelector("#rc-header-subtitle").value=l.header.subtitle),l.header?.headerColor&&(a.querySelector("#rc-header-color").value=l.header.headerColor,a.querySelector("#rc-header-color-text").value=l.header.headerColor),l.header?.gstNumber&&(a.querySelector("#rc-header-gstin").value=l.header.gstNumber),l.header?.showLogo!==void 0&&(a.querySelector("#rc-toggle-logo").checked=l.header.showLogo),l.header?.showAddress!==void 0&&(a.querySelector("#rc-toggle-address").checked=l.header.showAddress),l.header?.showPhone!==void 0&&(a.querySelector("#rc-toggle-contact").checked=l.header.showPhone),l.body?.showStudentId!==void 0&&(a.querySelector("#rc-toggle-stuId").checked=l.body.showStudentId!==!1),l.body?.showStudentPhone!==void 0&&(a.querySelector("#rc-toggle-stuPhone").checked=l.body.showStudentPhone!==!1),l.body?.showSeatNumber!==void 0&&(a.querySelector("#rc-toggle-seat").checked=l.body.showSeatNumber!==!1),l.body?.showPeriod!==void 0&&(a.querySelector("#rc-toggle-validity").checked=l.body.showPeriod!==!1),l.body?.showDiscount!==void 0&&(a.querySelector("#rc-toggle-breakdown").checked=l.body.showDiscount!==!1),l.body?.showPaymentMethod!==void 0&&(a.querySelector("#rc-toggle-paymentMode").checked=l.body.showPaymentMethod!==!1),l.stamp?.showStamp!==void 0&&(a.querySelector("#rc-toggle-stamp").checked=l.stamp.showStamp!==!1),l.stamp?.stampText&&(a.querySelector("#rc-stamp-text").value=l.stamp.stampText),l.stamp?.stampColor&&(a.querySelector("#rc-stamp-color").value=l.stamp.stampColor,a.querySelector("#rc-stamp-color-text").value=l.stamp.stampColor),l.footer?.signatureLabel&&(a.querySelector("#rc-signature-label").value=l.footer.signatureLabel),l.footer?.showSignature!==void 0&&(a.querySelector("#rc-toggle-signature").checked=l.footer.showSignature!==!1),l.footer?.showUpiQr!==void 0&&(a.querySelector("#rc-toggle-upiqr").checked=!!l.footer.showUpiQr),l.footer?.termsText&&(a.querySelector("#rc-terms-text").value=l.footer.termsText),l.footer?.customNote&&(a.querySelector("#rc-custom-note").value=l.footer.customNote),l.footer?.showTimestamp!==void 0&&(a.querySelector("#rc-toggle-timestamp").checked=l.footer.showTimestamp!==!1),window.store&&(window.store.settings||(window.store.settings={}),window.store.settings.receipt=l)}}catch(n){console.warn("Could not load receipt-config:",n)}const i=a.querySelector("#receipt-paper"),r=a.querySelector("#preview-format-badge"),b=()=>{if(!i)return;const n=e.businessName||"The Cozy Corner Study Library",l=e.address||"MG Road, Shivajinagar, Pune 411005",f=e.phone||"+91 98765 43210",E=e.email||"contact@cozystudylibrary.com",$=a.querySelector("#rc-header-gstin")?.value?.trim(),k=a.querySelector("#setting-bill-prefix")?.value?.trim()||"LIB-2026",I=a.querySelector("#rc-header-subtitle")?.value?.trim()||"Official Fee Receipt",D=a.querySelector("#rc-header-color")?.value||"#4f46e5",H=a.querySelector("#rc-toggle-logo")?.checked!==!1,z=a.querySelector("#rc-toggle-address")?.checked!==!1,x=a.querySelector("#rc-toggle-contact")?.checked!==!1,t=a.querySelector("#rc-toggle-stuId")?.checked!==!1,y=a.querySelector("#rc-toggle-stuPhone")?.checked!==!1,A=a.querySelector("#rc-toggle-seat")?.checked!==!1,g=a.querySelector("#rc-toggle-validity")?.checked!==!1,P=a.querySelector("#rc-toggle-breakdown")?.checked!==!1,q=a.querySelector("#rc-toggle-paymentMode")?.checked!==!1,T=a.querySelector("#rc-toggle-stamp")?.checked!==!1,L=a.querySelector("#rc-stamp-text")?.value?.trim()||"PAID \u2022 OFFICIAL RECEIPT",M=a.querySelector("#rc-stamp-color")?.value||"#059669",h=a.querySelector("#rc-toggle-signature")?.checked!==!1,d=a.querySelector("#rc-signature-label")?.value?.trim()||"Authorized Signatory",c=a.querySelector("#rc-toggle-upiqr")?.checked!==!1,w=a.querySelector("#setting-bill-upiId")?.value?.trim()||e.upiId||"thecozycorner@okaxis",p=a.querySelector("#rc-terms-text")?.value?.trim(),F=a.querySelector("#rc-custom-note")?.value?.trim(),B=a.querySelector("#rc-toggle-timestamp")?.checked!==!1;s==="thermal58"?(i.style.width="260px",i.style.fontSize="11px",i.style.padding="12px 10px",i.style.borderRadius="0px",i.style.fontFamily="'Courier New', Courier, monospace",r&&(r.textContent="POS Thermal 58mm")):s==="standardA4"?(i.style.width="480px",i.style.fontSize="12px",i.style.padding="28px 24px",i.style.borderRadius="4px",i.style.fontFamily="var(--font-family, sans-serif)",r&&(r.textContent="Standard A4 Invoice")):s==="modern_minimal"?(i.style.width="380px",i.style.fontSize="12px",i.style.padding="22px 20px",i.style.borderRadius="12px",i.style.boxShadow="0 10px 25px -5px rgba(0,0,0,0.15)",i.style.fontFamily="var(--font-family, sans-serif)",r&&(r.textContent="Modern Digital Pass")):(i.style.width="340px",i.style.fontSize="12.5px",i.style.padding="18px 16px",i.style.borderRadius="0px",i.style.fontFamily="'Courier New', Courier, monospace",r&&(r.textContent="POS Thermal 80mm")),i.innerHTML=`
        ...
        <div style="text-align: center; border-bottom: 1.5px dashed #333; padding-bottom: 10px; margin-bottom: 10px;">
          ...
          `:""}
          <div style="font-weight: 800; font-size: 1.05rem; text-transform: uppercase; color: ${D}; letter-spacing: 0.5px;">${u(n)}</div>
          <div style="font-size: 0.8rem; font-weight: 700; color: #555; text-transform: uppercase;">${u(I)}</div>
          ${z?`<div style="font-size: 0.72rem; color: #444; margin-top: 3px;">${u(l)}</div>`:""}
        ...
        ${T?`
          <div style="text-align: center; margin: 12px 0;">
            ...
            `:""}
            <div style="display: inline-block; border: 2.5px solid ${M}; color: ${M}; font-weight: 900; font-size: 0.95rem; padding: 4px 14px; border-radius: 6px; text-transform: uppercase; letter-spacing: 1px; transform: rotate(-3deg);">
              \u2714 ${u(L)}
            </div>
          </div>
        `:""}
      ...
      `};a.querySelectorAll(".receipt-format-card").forEach(n=>{n.addEventListener("click",()=>{a.querySelectorAll(".receipt-format-card").forEach(f=>{f.classList.remove("active"),f.style.border="1px solid var(--color-border)"}),n.classList.add("active"),n.style.border="2px solid var(--color-primary)",s=n.dataset.format,m&&(m.defaultTemplate=s,m["billing.defaultTemplate"]=s);const l=v||(typeof window<"u"?window.store:null);l&&l.settings&&l.settings.billing&&(l.settings.billing.defaultTemplate=s),b()})}),a.querySelectorAll("input, select, textarea").forEach(n=>{n.addEventListener("input",b),n.addEventListener("change",b)}),["#rc-header-color","#rc-stamp-color"].forEach(n=>{const l=a.querySelector(n),f=a.querySelector(n+"-text");l&&f&&(l.addEventListener("input",()=>{f.value=l.value,b()}),f.addEventListener("input",()=>{f.value.startsWith("#")&&f.value.length===7&&(l.value=f.value,b())}))}),a.querySelector("#btn-refresh-receipt-preview")?.addEventListener("click",b),a.querySelector("#btn-test-print-receipt")?.addEventListener("click",()=>{const n=window.open("","_blank"),l=i.innerHTML,f=s==="thermal58"?"58mm":s==="standardA4"?"210mm":"80mm";n.document.write(`
        <!DOCTYPE html>
        <html>
        <head>
          ...
          <style>
            ...
            body { 
              margin: 0; 
              padding: 10px; 
              font-family: ${s==="standardA4"?"sans-serif":"'Courier New', Courier, monospace"}; 
              font-size: ${s==="thermal58"?"11px":"13px"};
              color: #000;
              background: #fff;
              width: ${f};
      ...
      `),n.document.close()}),a.querySelector("#btn-save-receipt-builder")?.addEventListener("click",async()=>{const n=a.querySelector("#btn-save-receipt-builder");UI.buttonLoading(n,!0,"Saving Template...");const l=a.querySelector("#setting-bill-prefix")?.value?.trim()||"LIB-2026",f=a.querySelector("#rc-header-subtitle")?.value?.trim(),E=a.querySelector("#rc-header-color")?.value,$=a.querySelector("#rc-header-gstin")?.value?.trim(),k=a.querySelector("#rc-toggle-logo")?.checked,I=a.querySelector("#rc-toggle-address")?.checked,D=a.querySelector("#rc-toggle-contact")?.checked,H=a.querySelector("#rc-toggle-stuId")?.checked,z=a.querySelector("#rc-toggle-stuPhone")?.checked,x=a.querySelector("#rc-toggle-seat")?.checked,t=a.querySelector("#rc-toggle-validity")?.checked,y=a.querySelector("#rc-toggle-breakdown")?.checked,A=a.querySelector("#rc-toggle-paymentMode")?.checked,g=a.querySelector("#rc-toggle-stamp")?.checked,P=a.querySelector("#rc-stamp-text")?.value?.trim(),q=a.querySelector("#rc-stamp-color")?.value,T=a.querySelector("#rc-toggle-signature")?.checked,L=a.querySelector("#rc-signature-label")?.value?.trim(),M=a.querySelector("#rc-toggle-upiqr")?.checked,h=a.querySelector("#setting-bill-upiId")?.value?.trim(),d=a.querySelector("#rc-terms-text")?.value?.trim(),c=a.querySelector("#rc-custom-note")?.value?.trim(),w=a.querySelector("#rc-toggle-timestamp")?.checked,p=Number(a.querySelector("#setting-bill-gstRate")?.value||18),F=a.querySelector("#setting-bill-hsn")?.value?.trim()||"999293",B=Number(a.querySelector("#setting-bill-refundDays")?.value||3),N=a.querySelector("#setting-bank-accName")?.value?.trim(),_=a.querySelector("#setting-bank-accNo")?.value?.trim();try{const R={activeTemplate:s,header:{showLogo:k,showBusinessName:!0,subtitle:f,showAddress:I,showPhone:D,showEmail:D,showGst:!!$,gstNumber:$,headerColor:E},body:{showStudentId:H,showStudentPhone:z,showSeatNumber:x,showShift:x,showPeriod:t,showDiscount:y,showPaymentMethod:A,showTransactionId:A},stamp:{showStamp:g,stampText:P,stampColor:q,showWatermark:s==="standardA4"},footer:{showSignature:T,signatureLabel:L,showUpiQr:M,termsText:d,customNote:c,showTimestamp:w},gst:{enabled:p>0,gstRate:p,hsnCode:F}},[W,Q,j]=await Promise.all([C.put("/api/settings/receipt-config",R),C.put("/api/settings/system-settings",{billing:{receiptPrefix:l,defaultTemplate:s,gstRate:p,hsnSacCode:F,refundPolicyDays:B}}),C.put("/api/settings/business-profile",{upiId:h||e.upiId,gstNumber:$,bankDetails:{accountName:N||e.bankDetails?.accountName,accountNumber:_||e.bankDetails?.accountNumber}})]);W.success||Q.success?S.success("Receipt Builder template & billing configuration saved successfully!"):S.error(W.message||"Failed to save template")}catch(R){S.error(R.message||"Error saving receipt template")}finally{UI.buttonLoading(n,!1)}}),b()},50),a}function ne(){const e=document.createElement("div");return e.className="card",e.style.cssText="padding: 1.5rem; background: var(--color-surface); border: 1px solid var(--color-border); border-radius: var(--radius-lg);",e.innerHTML=`
    <div style="border-bottom: 1px solid var(--color-border); padding-bottom: 12px; margin-bottom: 1.25rem; display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 8px;">
      <div>
          ...
          <div class="card p-3 module-item-card" data-key="${u(r.key)}" style="background: var(--color-bg-secondary); border: 1.5px solid ${n?"rgba(0, 184, 148, 0.4)":"var(--color-border)"}; border-radius: var(--radius-md); transition: all 0.2s;">
            <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 8px;">
              ...
              <div class="form-check form-switch" style="padding-left: 2.5em; margin: 0;">
                <input class="form-check-input module-toggle-switch" type="checkbox" role="switch" data-key="${u(r.key)}" ${n?"checked":""} ${b?"disabled":""} style="width: 2.2em; height: 1.2em; cursor: ${b?"not-allowed":"pointer"};">
              </div>
            </div>
            ...
            <div class="module-details-body">
              ...
              <div style="display: flex; justify-content: space-between; align-items: center; border-top: 1px solid var(--color-border); padding-top: 8px; font-size: 0.75rem;">
                ...
                ${b?'<span class="badge badge-secondary" style="font-size: 0.65rem;">System Core</span>':'<span class="text-muted">Custom Module</span>'}
              </div>
            </div>
          </div>
        `}).join(""),i.querySelectorAll(".module-card-header").forEach(r=>{r.addEventListener("click",()=>{const b=r.closest(".module-item-card"),n=b?.querySelector(".module-details-body"),l=b?.querySelector(".module-toggle-caret");n&&(n.style.display==="none"?(n.style.display="block",l&&(l.textContent="\u25B2")):(n.style.display="none",l&&(l.textContent="\u25BC")))})}),i.querySelectorAll(".module-toggle-switch").forEach(r=>{r.addEventListener("change",()=>{const b=r.closest(".module-item-card"),n=b.querySelector(".module-status-badge");r.checked?(b.style.border="1.5px solid rgba(0, 184, 148, 0.4)",n.style.background="rgba(0, 184, 148, 0.15)",n.style.color="var(--color-success)",n.textContent="\u{1F7E2} Active & Visible"):(b.style.border="1.5px solid var(--color-border)",n.style.background="rgba(108, 117, 125, 0.15)",n.style.color="var(--color-text-muted)",n.textContent="\u26AA Disabled (Hidden)")})}),e.querySelector("#btn-modules-enable-all")?.addEventListener("click",()=>{i.querySelectorAll(".module-toggle-switch").forEach(r=>{r.checked=!0,r.dispatchEvent(new Event("change"))})}),e.querySelector("#btn-modules-disable-optional")?.addEventListener("click",()=>{i.querySelectorAll(".module-toggle-switch").forEach(r=>{if(!r.disabled){const b=r.dataset.key;["lockers","expenses","operations","reports","attendance","shifts"].includes(b)&&(r.checked=!1,r.dispatchEvent(new Event("change")))}})}),e.querySelector("#btn-save-modules-config")?.addEventListener("click",async()=>{const r=e.querySelector("#btn-save-modules-config");UI.buttonLoading(r,!0,"Saving Modules...");const b=o.map(n=>{const l=i.querySelector(`.module-toggle-switch[data-key="${n.key}"]`);return{...n,isEnabled:l?l.checked:n.isEnabled!==!1}});try{const n=await C.put("/api/settings/sidebar",{items:b});if(n.success){S.success("Module settings saved successfully! Navigation refreshed.");try{const l=b.filter(f=>f.isEnabled!==!1).map(f=>f.href);localStorage.setItem("sl_sidebar_order",JSON.stringify(l)),window.SidebarSortable&&window.SidebarSortable.init&&window.SidebarSortable.init(),window.dispatchEvent(new CustomEvent("sidebar-config-changed",{detail:b}))}catch{}}else S.error(n.message||"Failed to update modules")}catch(n){S.error(n.message||"Error updating module configuration")}finally{UI.buttonLoading(r,!1)}})}catch(m){console.error("Error in modules studio:",m)}},50),e}function X(e,m){const o=X,v=Array.isArray(e["notification.expiryReminderDays"])?e["notification.expiryReminderDays"].join(", "):e["notification.expiryReminderDays"]||e.expiryReminderDays||"7, 3, 1, 0",a=Array.isArray(e["notification.balanceReminderDays"])?e["notification.balanceReminderDays"].join(", "):e["notification.balanceReminderDays"]||e.balanceReminderDays||"7, 3, 1";return`
    <div class="card" style="padding: 1.5rem; background: var(--color-surface); border: 1px solid var(--color-border); border-radius: var(--radius-lg);">
      <div style="border-bottom: 1px solid var(--color-border); padding-bottom: 12px; margin-bottom: 1.25rem; display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 8px;">
        <div>
  ...
  `}function de(e,m){const o=document.createElement("div");return o.className="card",o.style.cssText="padding: 1.5rem; background: var(--color-surface); border: 1px solid var(--color-border); border-radius: var(--radius-lg);",o.innerHTML=`
    <div style="border-bottom: 1px solid var(--color-border); padding-bottom: 12px; margin-bottom: 1.25rem; display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 8px;">
      <div>
  ...
  `,setTimeout(()=>{o.querySelector("#btn-add-staff-member")?.addEventListener("click",()=>{const v=V.show({title:"\u2795 Add New Staff Team Member",content:`
        ...
        `,actions:[{text:"Cancel",class:"btn-secondary",onClick:()=>v.close()},{text:"Save Staff Member",class:"btn-primary",onClick:async()=>{const a=document.getElementById("staff-name")?.value?.trim(),s=document.getElementById("staff-email")?.value?.trim(),i=document.getElementById("staff-phone")?.value?.trim(),r=document.getElementById("staff-pwd")?.value?.trim(),b=document.getElementById("staff-role")?.value,n=document.getElementById("staff-branch")?.value||null;if(!a||!s||!r){S.error("Please enter name, email, and password");return}try{const l=await C.post("/api/auth/register",{name:a,email:s,phone:i,password:r,role:b,branch:n});l.success?(S.success(`Staff member ${a} created successfully!`),v.close(),G()):S.error(l.message||"Failed to create staff")}catch(l){S.error(l.message||"Error creating staff")}}}]})}),o.querySelectorAll(".btn-edit-staff").forEach(v=>{v.addEventListener("click",()=>{const a=v.dataset.id,s=e.find(n=>(n._id||n.id)===a);if(!s)return;const i=["Students","Seats","Plans","Payments","Expenses","Reports","Operations","Settings"],r=["View","Create","Edit","Delete","Export"],b=V.show({title:`\u270F\uFE0F Staff Permissions \u2014 ${u(s.name)}`,content:`
              ...
              <div class="row g-2 mb-3">
                <div class="col-md-6">
                  ...
                  <select id="edit-staff-role" class="form-select form-select-sm">
                    <option value="branch_manager" ${s.role==="branch_manager"?"selected":""}>Branch Manager</option>
                ...
                <div class="col-md-6">
                  ...
                  <select id="edit-staff-status" class="form-select form-select-sm">
                    <option value="true" ${s.isActive!==!1?"selected":""}>Active</option>
                    <option value="false" ${s.isActive===!1?"selected":""}>Inactive / Suspended</option>
                  </select>
                </div>
              </div>
          ...
          `,actions:[{text:"Cancel",class:"btn-secondary",onClick:()=>b.close()},{text:"Save Permissions",class:"btn-primary",onClick:async()=>{const n=document.getElementById("edit-staff-role")?.value,l=document.getElementById("edit-staff-status")?.value==="true";try{await C.put(`/api/auth/users/${a}`,{role:n,isActive:l}),S.success("Staff permissions updated successfully!"),b.close(),G()}catch(f){S.error(f.message||"Failed to update staff")}}}]})})}),o.querySelectorAll(".btn-del-staff").forEach(v=>{v.addEventListener("click",async()=>{const a=v.dataset.id;if(await ee.show("Are you sure you want to remove this staff account?"))try{await C.delete(`/api/auth/users/${a}`),S.success("Staff member removed successfully"),G()}catch(s){S.error(s.message||"Failed to delete staff")}})})},50),o}function ue(){const e=document.createElement("div");e.className="card cms-studio-container",e.style.cssText="padding: 1.5rem; background: var(--color-surface); border: 1px solid var(--color-border); border-radius: var(--radius-lg);";const m={modern_glass:{primary:"#6c5ce7",accent:"#00b894",secondary:"#3b82f6",font:"Outfit, sans-serif"},academic_clean:{primary:"#1e293b",accent:"#0284c7",secondary:"#64748b",font:"Inter, sans-serif"},dark_cyber:{primary:"#06b6d4",accent:"#10b981",secondary:"#8b5cf6",font:"Plus Jakarta Sans, sans-serif"},warm_cozy:{primary:"#b45309",accent:"#d97706",secondary:"#78350f",font:"Playfair Display, serif"}};let o="modern_glass",v=!1,a="split",s="all";return e.innerHTML=`
  ...
  `,setTimeout(async()=>{const i=e.querySelector("#cms-preview-frame"),r=e.querySelector("#cms-main-grid"),b=e.querySelector("#cms-preview-col"),n=e.querySelector("#cms-accordions-col"),l=e.querySelector("#btn-view-split"),f=e.querySelector("#btn-view-editor"),E=e.querySelector("#btn-view-preview"),$=x=>{a=x,[l,f,E].forEach(t=>{t&&(t.className="btn btn-xs btn-ghost text-muted")}),x==="split"?(l.className="btn btn-xs btn-primary",r.style.display="grid",r.style.gridTemplateColumns="1fr 1fr",n.style.display="flex",b.style.display="flex"):x==="editor"?(f.className="btn btn-xs btn-primary",r.style.display="block",n.style.display="flex",b.style.display="none"):x==="preview"&&(E.className="btn btn-xs btn-primary",r.style.display="block",n.style.display="none",b.style.display="flex")};l?.addEventListener("click",()=>$("split")),f?.addEventListener("click",()=>$("editor")),E?.addEventListener("click",()=>$("preview")),e.querySelectorAll(".cms-cat-btn").forEach(x=>{x.addEventListener("click",()=>{e.querySelectorAll(".cms-cat-btn").forEach(g=>{g.className="btn btn-xs btn-outline-secondary cms-cat-btn"}),x.className="btn btn-xs btn-primary cms-cat-btn",s=x.dataset.cat;let t=0,y=null;if(e.querySelectorAll(".cms-accordion-card").forEach(g=>{const P=g.dataset.category;s==="all"||P===s?(g.style.display="block",t++,y||(y=g)):g.style.display="none"}),y&&s!=="all"){const g=y.querySelector(".cms-accordion-body"),P=y.querySelector(".cms-accordion-toggle");g&&(g.style.display="block"),P&&(P.textContent="\u25B2")}const A=e.querySelector("#cms-sections-count-label");A&&(A.textContent=`\u2699\uFE0F Showing ${t} Section${t>1?"s":""}`)})});let k=[{label:"Online Admission",url:"/register",openInNewTab:!1},{label:"Student Portal",url:"/student-login",openInNewTab:!1},{label:"Gate Kiosk",url:"/kiosk",openInNewTab:!1},{label:"Staff & Owner Login",url:"/#/",openInNewTab:!1}];const I=()=>{if(!i||!i.contentWindow)return;const x=k.filter(t=>t&&t.label&&t.url);i.contentWindow.postMessage({type:"LIVE_CMS_UPDATE",preset:o,primaryColor:e.querySelector("#cms-color-primary")?.value,accentColor:e.querySelector("#cms-color-accent")?.value,secondaryColor:e.querySelector("#cms-color-secondary")?.value,fontFamily:e.querySelector("#cms-font-family")?.value,heroTitle:e.querySelector("#cms-hero-title")?.value,heroSubtitle:e.querySelector("#cms-hero-subtitle")?.value,announcementTicker:e.querySelector("#cms-hero-ticker")?.value,footerLinksHeading:e.querySelector("#cms-footer-links-heading")?.value?.trim()||"Quick Links",quickLinks:x,footerTagline:e.querySelector("#cms-footer-tagline")?.value,navBrand:e.querySelector("#cms-nav-brand-name")?.value},"*")},D=()=>{const x=e.querySelector("#cms-qlinks-container");if(x){if(k.length===0){x.innerHTML=`
      ...
      `).join(""),x.querySelectorAll(".qlink-input-label").forEach((t,y)=>{t.addEventListener("input",A=>{k[y]&&(k[y].label=A.target.value),I()})}),x.querySelectorAll(".qlink-input-url").forEach((t,y)=>{t.addEventListener("input",A=>{k[y]&&(k[y].url=A.target.value),I()})}),x.querySelectorAll(".qlink-input-newtab").forEach((t,y)=>{t.addEventListener("change",A=>{k[y]&&(k[y].openInNewTab=A.target.checked),I()})}),x.querySelectorAll(".btn-delete-qlink").forEach(t=>{t.addEventListener("click",()=>{const y=parseInt(t.dataset.index,10);k.splice(y,1),D(),I()})})}};e.querySelector("#btn-add-cms-qlink")?.addEventListener("click",()=>{k.push({label:"New Link",url:"/",openInNewTab:!1}),D(),I()}),e.querySelectorAll(".btn-preset-qlink").forEach(x=>{x.addEventListener("click",()=>{const t=x.dataset.label,y=x.dataset.url;k.some(A=>A.url===y)||(k.push({label:t,url:y,openInNewTab:!1}),D(),I())})}),i&&i.addEventListener("load",()=>{setTimeout(I,350)});try{const x=await C.get("/api/landing");if(x.success&&x.data){const{landing:t={},businessProfile:y={}}=x.data;t.theme?.preset&&(o=t.theme.preset,e.querySelectorAll(".theme-preset-card").forEach(g=>{g.dataset.preset===o?(g.classList.add("active"),g.style.border="2px solid var(--color-primary)"):(g.classList.remove("active"),g.style.border="1px solid var(--color-border)")})),t.theme?.primaryColor&&(e.querySelector("#cms-color-primary").value=t.theme.primaryColor,e.querySelector("#cms-color-primary-text").value=t.theme.primaryColor),t.theme?.accentColor&&(e.querySelector("#cms-color-accent").value=t.theme.accentColor,e.querySelector("#cms-color-accent-text").value=t.theme.accentColor),t.theme?.secondaryColor&&(e.querySelector("#cms-color-secondary").value=t.theme.secondaryColor,e.querySelector("#cms-color-secondary-text").value=t.theme.secondaryColor),t.theme?.fontFamily&&(e.querySelector("#cms-font-family").value=t.theme.fontFamily),t.hero?.enableTicker!==void 0&&(e.querySelector("#cms-ticker-enabled").checked=t.hero.enableTicker),t.hero?.tickerText&&(e.querySelector("#cms-hero-ticker").value=t.hero.tickerText),t.hero?.liveSeatBadge?.text&&(e.querySelector("#cms-live-seat-text").value=t.hero.liveSeatBadge.text),t.navbar?.brandName&&(e.querySelector("#cms-nav-brand-name").value=t.navbar.brandName),t.navbar?.ctaPrimaryText&&(e.querySelector("#cms-nav-cta-primary-text").value=t.navbar.ctaPrimaryText),t.navbar?.ctaPrimaryLink&&(e.querySelector("#cms-nav-cta-primary-link").value=t.navbar.ctaPrimaryLink),t.navbar?.ctaSecondaryText&&(e.querySelector("#cms-nav-cta-sec-text").value=t.navbar.ctaSecondaryText),t.navbar?.ctaSecondaryLink&&(e.querySelector("#cms-nav-cta-sec-link").value=t.navbar.ctaSecondaryLink),t.navbar?.showDarkModeToggle!==void 0&&(e.querySelector("#cms-nav-dark-toggle").checked=t.navbar.showDarkModeToggle),t.hero?.title&&(e.querySelector("#cms-hero-title").value=t.hero.title),t.hero?.subtitle&&(e.querySelector("#cms-hero-subtitle").value=t.hero.subtitle),t.hero?.ctaPrimaryText&&(e.querySelector("#cms-hero-cta-text").value=t.hero.ctaPrimaryText),t.hero?.ctaPrimaryLink&&(e.querySelector("#cms-hero-cta-link").value=t.hero.ctaPrimaryLink),t.hero?.ctaSecondaryText&&(e.querySelector("#cms-hero-sec-text").value=t.hero.ctaSecondaryText),t.hero?.ctaSecondaryLink&&(e.querySelector("#cms-hero-sec-link").value=t.hero.ctaSecondaryLink),Array.isArray(t.hero?.badges)&&t.hero.badges.forEach((g,P)=>{const q=e.querySelector(`#cms-hero-badge-${P+1}`);q&&(q.value=g)}),t.facilities?.title&&(e.querySelector("#cms-fac-title").value=t.facilities.title),t.facilities?.subtitle&&(e.querySelector("#cms-fac-subtitle").value=t.facilities.subtitle),Array.isArray(t.facilities?.items)&&t.facilities.items.forEach((g,P)=>{const q=P+1,T=e.querySelector(`#cms-fac-icon-${q}`),L=e.querySelector(`#cms-fac-title-${q}`),M=e.querySelector(`#cms-fac-desc-${q}`);T&&g.icon&&(T.value=g.icon),L&&g.title&&(L.value=g.title),M&&g.description&&(M.value=g.description)}),t.shifts?.title&&(e.querySelector("#cms-shifts-title").value=t.shifts.title),t.shifts?.subtitle&&(e.querySelector("#cms-shifts-subtitle").value=t.shifts.subtitle),Array.isArray(t.shifts?.items)&&t.shifts.items.forEach((g,P)=>{const q=P+1,T=e.querySelector(`#cms-shift-icon-${q}`),L=e.querySelector(`#cms-shift-name-${q}`),M=e.querySelector(`#cms-shift-time-${q}`),h=e.querySelector(`#cms-shift-desc-${q}`);T&&g.icon&&(T.value=g.icon),L&&g.name&&(L.value=g.name),M&&g.timing&&(M.value=g.timing),h&&g.description&&(h.value=g.description)}),t.pricing?.badge&&(e.querySelector("#cms-plans-badge").value=t.pricing.badge),t.pricing?.title&&(e.querySelector("#cms-plans-title").value=t.pricing.title),t.pricing?.subtitle&&(e.querySelector("#cms-plans-subtitle").value=t.pricing.subtitle),t.about?.title&&(e.querySelector("#cms-about-title").value=t.about.title),t.about?.subtitle&&(e.querySelector("#cms-about-subtitle").value=t.about.subtitle),t.about?.description&&(e.querySelector("#cms-about-desc").value=t.about.description),Array.isArray(t.about?.highlightPoints)&&t.about.highlightPoints.forEach((g,P)=>{const q=e.querySelector(`#cms-about-hl-${P+1}`);q&&(q.value=g)}),Array.isArray(t.about?.stats)&&t.about.stats.forEach((g,P)=>{const q=P+1,T=e.querySelector(`#cms-stat-num-${q}`),L=e.querySelector(`#cms-stat-lbl-${q}`);T&&g.number&&(T.value=g.number),L&&g.label&&(L.value=g.label)}),t.gallery?.title&&(e.querySelector("#cms-gallery-title").value=t.gallery.title),t.gallery?.subtitle&&(e.querySelector("#cms-gallery-subtitle").value=t.gallery.subtitle);const A=t.gallery?.images||t.gallery?.items;if(Array.isArray(A)&&A.forEach((g,P)=>{const q=P+1,T=e.querySelector(`#cms-gal-url-${q}`),L=e.querySelector(`#cms-gal-cat-${q}`),M=e.querySelector(`#cms-gal-cap-${q}`);T&&g.url&&(T.value=g.url),L&&g.category&&(L.value=g.category),M&&g.caption&&(M.value=g.caption)}),t.testimonials?.title&&(e.querySelector("#cms-test-title").value=t.testimonials.title),t.testimonials?.googleRating&&(e.querySelector("#cms-test-rating").value=t.testimonials.googleRating),t.testimonials?.googleReviewsCount&&(e.querySelector("#cms-test-count").value=t.testimonials.googleReviewsCount),Array.isArray(t.testimonials?.items)&&t.testimonials.items.forEach((g,P)=>{const q=P+1,T=e.querySelector(`#cms-test-name-${q}`),L=e.querySelector(`#cms-test-exam-${q}`),M=e.querySelector(`#cms-test-text-${q}`);T&&g.name&&(T.value=g.name),L&&g.exam&&(L.value=g.exam),M&&g.feedback&&(M.value=g.feedback)}),t.faqs?.title&&(e.querySelector("#cms-faqs-title").value=t.faqs.title),t.faqs?.subtitle&&(e.querySelector("#cms-faqs-subtitle").value=t.faqs.subtitle),Array.isArray(t.faqs?.items)&&t.faqs.items.forEach((g,P)=>{const q=P+1,T=e.querySelector(`#cms-faq-q-${q}`),L=e.querySelector(`#cms-faq-a-${q}`);T&&g.question&&(T.value=g.question),L&&g.answer&&(L.value=g.answer)}),t.rules?.title&&(e.querySelector("#cms-rules-title").value=t.rules.title),t.rules?.subtitle&&(e.querySelector("#cms-rules-subtitle").value=t.rules.subtitle),Array.isArray(t.rules?.items)&&t.rules.items.forEach((g,P)=>{const q=e.querySelector(`#cms-rule-${P+1}`);q&&(q.value=g)}),t.enquiry?.title&&(e.querySelector("#cms-enquiry-title").value=t.enquiry.title),t.enquiry?.subtitle&&(e.querySelector("#cms-enquiry-subtitle").value=t.enquiry.subtitle),t.enquiry?.successMessage&&(e.querySelector("#cms-enquiry-success").value=t.enquiry.successMessage),(t.contact?.phone||y.phone)&&(e.querySelector("#cms-contact-phone").value=t.contact?.phone||y.phone||""),(t.contact?.whatsapp||y.socialLinks?.whatsapp||y.phone)&&(e.querySelector("#cms-contact-wa").value=t.contact?.whatsapp||y.socialLinks?.whatsapp||y.phone||""),(t.contact?.email||y.email)&&(e.querySelector("#cms-contact-email").value=t.contact?.email||y.email||""),t.contact?.openingHours&&(e.querySelector("#cms-opening-hours").value=t.contact.openingHours),(t.contact?.address||y.address)&&(e.querySelector("#cms-contact-address").value=t.contact?.address||y.address||""),(y.mapEmbedUrl||t.footer?.mapEmbedUrl||t.contact?.googleMapEmbedUrl)&&(e.querySelector("#cms-map-embed").value=y.mapEmbedUrl||t.footer?.mapEmbedUrl||t.contact?.googleMapEmbedUrl||""),t.footer?.mapDirectLink&&(e.querySelector("#cms-map-direct").value=t.footer.mapDirectLink),t.floatingActions?.enabled!==void 0&&(e.querySelector("#cms-floating-enabled").checked=t.floatingActions.enabled),(t.floatingActions?.whatsappNumber||y.phone)&&(e.querySelector("#cms-floating-whatsapp").value=t.floatingActions?.whatsappNumber||y.phone||""),(t.floatingActions?.callNumber||y.phone)&&(e.querySelector("#cms-floating-call").value=t.floatingActions?.callNumber||y.phone||""),t.floatingActions?.whatsappMessage&&(e.querySelector("#cms-floating-wa-msg").value=t.floatingActions.whatsappMessage),t.footer?.orgName&&(e.querySelector("#cms-footer-org-name").value=t.footer.orgName),t.footer?.tagline&&(e.querySelector("#cms-footer-tagline").value=t.footer.tagline),t.footer?.copyrightText&&(e.querySelector("#cms-footer-copy-text").value=t.footer.copyrightText),t.footer?.linksHeading){const g=e.querySelector("#cms-footer-links-heading");g&&(g.value=t.footer.linksHeading)}Array.isArray(t.footer?.quickLinks)&&t.footer.quickLinks.length>0&&(k=t.footer.quickLinks.map(g=>({label:g.label||"",url:g.url||"",openInNewTab:!!g.openInNewTab}))),D(),t.seo?.metaTitle&&(e.querySelector("#cms-seo-title").value=t.seo.metaTitle),t.seo?.metaDescription&&(e.querySelector("#cms-seo-desc").value=t.seo.metaDescription),t.seo?.metaKeywords&&(e.querySelector("#cms-seo-keywords").value=t.seo.metaKeywords),t.seo?.googleAnalyticsId&&(e.querySelector("#cms-seo-ga").value=t.seo.googleAnalyticsId),t.seo?.metaPixelId&&(e.querySelector("#cms-seo-pixel").value=t.seo.metaPixelId),i&&(i.src=`/landing?preview=true&theme=${o}&t=${Date.now()}`)}}catch(x){console.warn("Failed to load landing config:",x)}e.querySelectorAll(".theme-preset-card").forEach(x=>{x.addEventListener("click",()=>{e.querySelectorAll(".theme-preset-card").forEach(y=>{y.classList.remove("active"),y.style.border="1px solid var(--color-border)"}),x.classList.add("active"),x.style.border="2px solid var(--color-primary)",o=x.dataset.preset;const t=m[o]||m.modern_glass;e.querySelector("#cms-color-primary").value=t.primary,e.querySelector("#cms-color-primary-text").value=t.primary,e.querySelector("#cms-color-accent").value=t.accent,e.querySelector("#cms-color-accent-text").value=t.accent,e.querySelector("#cms-color-secondary").value=t.secondary,e.querySelector("#cms-color-secondary-text").value=t.secondary,e.querySelector("#cms-font-family").value=t.font,i&&(i.src=`/landing?preview=true&theme=${o}&t=${Date.now()}`),setTimeout(I,150)})}),["primary","accent","secondary"].forEach(x=>{const t=e.querySelector(`#cms-color-${x}`),y=e.querySelector(`#cms-color-${x}-text`);t&&y&&(t.addEventListener("input",()=>{y.value=t.value,I()}),y.addEventListener("input",()=>{y.value.startsWith("#")&&y.value.length===7&&(t.value=y.value,I())}))}),["#cms-font-family","#cms-hero-title","#cms-hero-subtitle","#cms-hero-ticker","#cms-footer-tagline","#cms-nav-brand-name","#cms-qlink-lbl-1","#cms-qlink-url-1","#cms-qlink-lbl-2","#cms-qlink-url-2","#cms-qlink-lbl-3","#cms-qlink-url-3","#cms-qlink-lbl-4","#cms-qlink-url-4"].forEach(x=>{e.querySelector(x)?.addEventListener("input",I)});const H=e.querySelector("#btn-preview-mode-desktop"),z=e.querySelector("#btn-preview-mode-mobile");H?.addEventListener("click",()=>{v=!1,H.classList.replace("btn-outline-secondary","btn-primary"),z.classList.replace("btn-primary","btn-outline-secondary"),i&&(i.style.width="100%",i.style.maxWidth="100%")}),z?.addEventListener("click",()=>{v=!0,z.classList.replace("btn-outline-secondary","btn-primary"),H.classList.replace("btn-primary","btn-outline-secondary"),i&&(i.style.width="375px",i.style.maxWidth="375px",i.style.boxShadow="0 0 20px rgba(0,0,0,0.5)",i.style.borderRadius="16px")}),e.querySelector("#btn-preview-reload")?.addEventListener("click",()=>{i&&(i.src=`/landing?preview=true&theme=${o}&t=${Date.now()}`)}),e.querySelector("#btn-save-website-cms")?.addEventListener("click",async()=>{const x=e.querySelector("#btn-save-website-cms");UI.buttonLoading(x,!0,"Publishing...");try{const t=[e.querySelector("#cms-hero-badge-1")?.value?.trim(),e.querySelector("#cms-hero-badge-2")?.value?.trim(),e.querySelector("#cms-hero-badge-3")?.value?.trim(),e.querySelector("#cms-hero-badge-4")?.value?.trim()].filter(Boolean),y=[];for(let w=1;w<=6;w++){const p=e.querySelector(`#cms-fac-icon-${w}`)?.value?.trim()||"\u2744\uFE0F",F=e.querySelector(`#cms-fac-title-${w}`)?.value?.trim(),B=e.querySelector(`#cms-fac-desc-${w}`)?.value?.trim()||"";F&&y.push({icon:p,title:F,description:B})}const A=[];for(let w=1;w<=4;w++){const p=e.querySelector(`#cms-shift-icon-${w}`)?.value?.trim()||"\u23F0",F=e.querySelector(`#cms-shift-name-${w}`)?.value?.trim(),B=e.querySelector(`#cms-shift-time-${w}`)?.value?.trim()||"",N=e.querySelector(`#cms-shift-desc-${w}`)?.value?.trim()||"";F&&A.push({icon:p,name:F,timing:B,description:N,enabled:!0})}const g=[e.querySelector("#cms-about-hl-1")?.value?.trim(),e.querySelector("#cms-about-hl-2")?.value?.trim(),e.querySelector("#cms-about-hl-3")?.value?.trim(),e.querySelector("#cms-about-hl-4")?.value?.trim()].filter(Boolean),P=[];for(let w=1;w<=4;w++){const p=e.querySelector(`#cms-stat-num-${w}`)?.value?.trim(),F=e.querySelector(`#cms-stat-lbl-${w}`)?.value?.trim();(p||F)&&P.push({number:p||"",label:F||""})}const q=[];for(let w=1;w<=4;w++){const p=e.querySelector(`#cms-gal-url-${w}`)?.value?.trim(),F=e.querySelector(`#cms-gal-cat-${w}`)?.value?.trim()||"Hall",B=e.querySelector(`#cms-gal-cap-${w}`)?.value?.trim()||"";p&&q.push({url:p,category:F,caption:B})}const T=[];for(let w=1;w<=3;w++){const p=e.querySelector(`#cms-test-name-${w}`)?.value?.trim(),F=e.querySelector(`#cms-test-exam-${w}`)?.value?.trim()||"Aspirant",B=e.querySelector(`#cms-test-text-${w}`)?.value?.trim();p&&B&&T.push({name:p,exam:F,feedback:B,rating:5})}const L=[];for(let w=1;w<=4;w++){const p=e.querySelector(`#cms-faq-q-${w}`)?.value?.trim(),F=e.querySelector(`#cms-faq-a-${w}`)?.value?.trim();p&&F&&L.push({question:p,answer:F})}const M=[];for(let w=1;w<=5;w++){const p=e.querySelector(`#cms-rule-${w}`)?.value?.trim();p&&M.push(p)}const h=k.map(w=>({label:w.label?.trim()||"",url:w.url?.trim()||"",openInNewTab:!!w.openInNewTab})).filter(w=>w.label&&w.url),d={theme:{preset:o,primaryColor:e.querySelector("#cms-color-primary")?.value,accentColor:e.querySelector("#cms-color-accent")?.value,secondaryColor:e.querySelector("#cms-color-secondary")?.value,fontFamily:e.querySelector("#cms-font-family")?.value},hero:{title:e.querySelector("#cms-hero-title")?.value?.trim(),subtitle:e.querySelector("#cms-hero-subtitle")?.value?.trim(),enableTicker:e.querySelector("#cms-ticker-enabled")?.checked,tickerText:e.querySelector("#cms-hero-ticker")?.value?.trim(),liveSeatBadge:{enabled:!0,text:e.querySelector("#cms-live-seat-text")?.value?.trim()||"Only 12 Seats Left"},ctaPrimaryText:e.querySelector("#cms-hero-cta-text")?.value?.trim()||"Apply for Admission / Register Now",ctaPrimaryLink:e.querySelector("#cms-hero-cta-link")?.value?.trim()||"/register",ctaSecondaryText:e.querySelector("#cms-hero-sec-text")?.value?.trim()||"Send Quick Enquiry",ctaSecondaryLink:e.querySelector("#cms-hero-sec-link")?.value?.trim()||"#enquiry",badges:t},navbar:{brandName:e.querySelector("#cms-nav-brand-name")?.value?.trim()||"",ctaPrimaryText:e.querySelector("#cms-nav-cta-primary-text")?.value?.trim()||"Register Now",ctaPrimaryLink:e.querySelector("#cms-nav-cta-primary-link")?.value?.trim()||"/register",ctaSecondaryText:e.querySelector("#cms-nav-cta-sec-text")?.value?.trim()||"Student Portal",ctaSecondaryLink:e.querySelector("#cms-nav-cta-sec-link")?.value?.trim()||"/student-login",showDarkModeToggle:e.querySelector("#cms-nav-dark-toggle")?.checked},facilities:{enabled:!0,title:e.querySelector("#cms-fac-title")?.value?.trim()||"Premium Facilities & Amenities",subtitle:e.querySelector("#cms-fac-subtitle")?.value?.trim()||"",items:y},shifts:{enabled:!0,title:e.querySelector("#cms-shifts-title")?.value?.trim()||"Flexible Study Shifts",subtitle:e.querySelector("#cms-shifts-subtitle")?.value?.trim()||"",items:A},pricing:{enabled:!0,badge:e.querySelector("#cms-plans-badge")?.value?.trim()||"PRICING",title:e.querySelector("#cms-plans-title")?.value?.trim()||"Transparent & Student-Friendly Membership Plans",subtitle:e.querySelector("#cms-plans-subtitle")?.value?.trim()||""},about:{enabled:!0,title:e.querySelector("#cms-about-title")?.value?.trim()||"About Our Study Library",subtitle:e.querySelector("#cms-about-subtitle")?.value?.trim()||"",description:e.querySelector("#cms-about-desc")?.value?.trim()||"",highlightPoints:g,stats:P},gallery:{enabled:!0,title:e.querySelector("#cms-gallery-title")?.value?.trim()||"Library Hall & Infrastructure Gallery",subtitle:e.querySelector("#cms-gallery-subtitle")?.value?.trim()||"",images:q},testimonials:{enabled:!0,title:e.querySelector("#cms-test-title")?.value?.trim()||"What Our Students Say",googleRating:e.querySelector("#cms-test-rating")?.value?.trim()||"4.9",googleReviewsCount:e.querySelector("#cms-test-count")?.value?.trim()||"250+ Reviews",items:T},faqs:{enabled:!0,title:e.querySelector("#cms-faqs-title")?.value?.trim()||"Frequently Asked Questions",subtitle:e.querySelector("#cms-faqs-subtitle")?.value?.trim()||"",items:L},rules:{enabled:!0,title:e.querySelector("#cms-rules-title")?.value?.trim()||"Library Rules & Discipline Guidelines",subtitle:e.querySelector("#cms-rules-subtitle")?.value?.trim()||"",items:M},enquiry:{enabled:!0,title:e.querySelector("#cms-enquiry-title")?.value?.trim()||"Have Questions? Send Us an Enquiry",subtitle:e.querySelector("#cms-enquiry-subtitle")?.value?.trim()||"",successMessage:e.querySelector("#cms-enquiry-success")?.value?.trim()||""},contact:{enabled:!0,phone:e.querySelector("#cms-contact-phone")?.value?.trim()||"",whatsapp:e.querySelector("#cms-contact-wa")?.value?.trim()||"",email:e.querySelector("#cms-contact-email")?.value?.trim()||"",address:e.querySelector("#cms-contact-address")?.value?.trim()||"",openingHours:e.querySelector("#cms-opening-hours")?.value?.trim()||"",googleMapEmbedUrl:e.querySelector("#cms-map-embed")?.value?.trim()||""},floatingActions:{enabled:e.querySelector("#cms-floating-enabled")?.checked,whatsappNumber:e.querySelector("#cms-floating-whatsapp")?.value?.trim()||"",whatsappMessage:e.querySelector("#cms-floating-wa-msg")?.value?.trim()||"Hello! I am interested in library admission.",callNumber:e.querySelector("#cms-floating-call")?.value?.trim()||""},footer:{enabled:!0,showLinks:!0,linksHeading:e.querySelector("#cms-footer-links-heading")?.value?.trim()||"Quick Links",orgName:e.querySelector("#cms-footer-org-name")?.value?.trim()||"",tagline:e.querySelector("#cms-footer-tagline")?.value?.trim()||"",copyrightText:e.querySelector("#cms-footer-copy-text")?.value?.trim()||"",mapEmbedUrl:e.querySelector("#cms-map-embed")?.value?.trim()||"",mapDirectLink:e.querySelector("#cms-map-direct")?.value?.trim()||"",quickLinks:h},seo:{metaTitle:e.querySelector("#cms-seo-title")?.value?.trim()||"",metaDescription:e.querySelector("#cms-seo-desc")?.value?.trim()||"",metaKeywords:e.querySelector("#cms-seo-keywords")?.value?.trim()||"",googleAnalyticsId:e.querySelector("#cms-seo-ga")?.value?.trim()||"",metaPixelId:e.querySelector("#cms-seo-pixel")?.value?.trim()||""},businessProfile:{mapEmbedUrl:e.querySelector("#cms-map-embed")?.value?.trim()||"",phone:e.querySelector("#cms-contact-phone")?.value?.trim()||"",email:e.querySelector("#cms-contact-email")?.value?.trim()||"",address:e.querySelector("#cms-contact-address")?.value?.trim()||""}},c=await C.put("/api/landing",d);if(c.success){try{localStorage.removeItem("sl_public_profile_cache")}catch{}S.success("Public Website published live with all 17 customization sections!"),I(),i&&(i.src=`/landing?preview=true&theme=${o}&t=${Date.now()}`)}else S.error(c.message||"Failed to publish website")}catch(t){S.error(t.message||"Error publishing website")}finally{UI.buttonLoading(x,!1)}})},50),e}function me(e,m){const o=a=>e[`portal.${a}`]!==!1&&e[a]!==!1,v=[{key:"enableOnlineRenewal",title:"\u{1F4B3} Online UPI Fee Renewal",desc:"Allows students to pay fees online via QR code & UPI intent apps"},{key:"enableSeatTransfer",title:"\u{1F504} Seat / Desk Transfer Requests",desc:"Allows students to submit self-service seat transfer requests"},{key:"enableShiftSwitch",title:"\u{1F552} Shift Switch Requests",desc:"Allows students to request shift timing changes"},{key:"enableIdPassDownload",title:"\u{1FAAA} Digital Mobile ID Pass Download",desc:"Generates 1080x1920px 9:16 mobile wallpaper ID passes"},{key:"enableReceiptDownload",title:"\u{1F9FE} Fee Receipt PDF Download",desc:"Allows students to download official fee payment invoices"},{key:"enableProfileEdit",title:"\u{1F464} Profile & KYC Self-Edit",desc:"Permits students to update phone, emergency contacts, and photo"},{key:"enableWebAuthn",title:"\u{1F510} One-Touch Biometric FaceID Login",desc:"Enables passkey and fingerprint authentication"},{key:"enableGamifiedBadges",title:"\u{1F3C6} Gamified Badges & Study Streak",desc:"Displays study streak milestones and achievement trophies"},{key:"enableReferralProgram",title:"\u{1F381} Referral Program & Cashback Wallet",desc:"Enables referral sharing links and cashback balances"},{key:"enableAttendanceLogs",title:"\u{1F4CA} 30-Day AI Study Heatmap",desc:"Displays attendance heatmap logs and study duration graph"},{key:"enableAnnouncements",title:"\u{1F4E2} Notice Board & Announcements",desc:"Displays library alerts and emergency closure banners"},{key:"enableLockerRequests",title:"\u{1F512} Locker Allotment Requests",desc:"Allows students to request personal locker storage"}];return`
    <div class="card" style="padding: 1.5rem; background: var(--color-surface); border: 1px solid var(--color-border); border-radius: var(--radius-lg);">
      <div style="border-bottom: 1px solid var(--color-border); padding-bottom: 12px; margin-bottom: 1.25rem; display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 8px;">
        <div>
            ...
            ${v.map(a=>`
              <div class="card p-3" style="background: var(--color-bg-secondary); border: 1px solid var(--color-border); border-radius: var(--radius-md); display: flex; justify-content: space-between; align-items: center; gap: 12px;">
                ...
                <div class="form-check form-switch" style="margin: 0; font-size: 1.2rem;">
                  <input class="form-check-input student-portal-toggle" type="checkbox" data-key="${a.key}" ${o(a.key)?"checked":""}>
                </div>
              </div>
            `).join("")}
          </div>
  ...
  `,setTimeout(async()=>{const o=m.querySelector("#ai-insights-mount-container");if(o)try{const v=(await C.get("/api/ai/insights"))?.data||{},a=v.financialSummary||{},s=v.occupancySummary||{},i=v.retentionRisks||[];o.innerHTML=`
        <div class="row g-3">
          ...
          <div class="col-md-6">
            <div class="card p-3" style="background: linear-gradient(135deg, rgba(59,130,246,0.08), rgba(16,185,129,0.08)); border: 1px solid var(--color-border);">
              ...
              <div style="font-size: 1.6rem; font-weight: 800; margin: 4px 0;">${s.occupancyRate||0}% Occupied</div>
              <div style="font-size: 0.82rem; color: var(--color-text-primary); font-weight: 600;">
                ${s.occupiedSeats||0} occupied / ${s.totalSeats||0} total desks (${s.availableSeats||0} vacant)
              </div>
              <div style="font-size: 0.78rem; color: var(--color-text-secondary); margin-top: 6px;">
                \u{1F4A1} <em>${u(s.insight||"Capacity optimal.")}</em>
              </div>
            </div>
          </div>
      ...
      `}catch{o.innerHTML='<p class="text-muted p-3 text-center">AI insights calculation active.</p>'}},50),m}function pe(){return`
    <div class="card" style="padding: 1.5rem; background: var(--color-surface); border: 1px solid var(--color-border); border-radius: var(--radius-lg);">
      <div style="border-bottom: 1px solid var(--color-border); padding-bottom: 12px; margin-bottom: 1.25rem; display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 8px;">
        <div>
  ...
  `}function ge(e){e&&(e.querySelectorAll(".settings-accordion-header, .cms-accordion-header").forEach(m=>{m.dataset.accordionBound||(m.dataset.accordionBound="true",m.addEventListener("click",o=>{if(o.target.closest("input, select, .form-switch, .form-check, label.form-check-label")&&!o.target.closest(".settings-accordion-toggle, .cms-accordion-toggle"))return;const v=m.closest(".settings-accordion-card, .cms-accordion-card")||m.parentElement,a=m.nextElementSibling||v.querySelector(".settings-accordion-body, .cms-accordion-body"),s=m.querySelector(".settings-accordion-toggle, .cms-accordion-toggle");a&&(!a.style.display||a.style.display==="none"||window.getComputedStyle(a).display==="none"?(a.style.display="block",s&&(s.textContent="\u25B2")):(a.style.display="none",s&&(s.textContent="\u25BC")))}))}),e.querySelectorAll(".btn-expand-all-sections, #btn-cms-expand-all, #btn-modules-expand-all").forEach(m=>{m.dataset.bound||(m.dataset.bound="true",m.addEventListener("click",()=>{e.querySelectorAll(".settings-accordion-body, .cms-accordion-body, .module-details-body").forEach(o=>o.style.display="block"),e.querySelectorAll(".settings-accordion-toggle, .cms-accordion-toggle, .module-toggle-caret").forEach(o=>o.textContent="\u25B2")}))}),e.querySelectorAll(".btn-collapse-all-sections, #btn-cms-collapse-all, #btn-modules-collapse-all").forEach(m=>{m.dataset.bound||(m.dataset.bound="true",m.addEventListener("click",()=>{e.querySelectorAll(".settings-accordion-body, .cms-accordion-body, .module-details-body").forEach(o=>o.style.display="none"),e.querySelectorAll(".settings-accordion-toggle, .cms-accordion-toggle, .module-toggle-caret").forEach(o=>o.textContent="\u25BC")}))}))}function J(e,m,o){e.querySelector("#btn-save-reg-payment-methods")?.addEventListener("click",async()=>{try{const a=e.querySelectorAll(".setting-paymethod-row");if(a.length===0)return;const s=Array.from(a).map((r,b)=>({key:r.dataset.key,name:r.querySelector(".spm-name")?.value?.trim()||r.dataset.name,subtitle:r.querySelector(".spm-sub")?.value?.trim()||"",icon:r.dataset.icon||"\u{1F4B3}",enabled:r.querySelector(".spm-enabled")?r.querySelector(".spm-enabled").checked:!0,order:b+1,instructions:r.querySelector(".spm-instructions")?.value?.trim()||"",requiresRef:r.querySelector(".spm-reqref")?r.querySelector(".spm-reqref").checked:!0,refLabel:r.querySelector(".spm-reflabel")?.value?.trim()||"Transaction Reference / UTR *"}));O.show("Saving Self-Registration Payment Methods...");const i=await C.put("/api/settings/business-profile",{paymentMethods:s});O.hide(),i.success?(o&&o.profile&&(o.profile.paymentMethods=s),S.success("\u2705 Self-registration payment options updated successfully! Changes are live on the registration portal.")):S.error(i.message||"Failed to save payment options")}catch(a){O.hide(),S.error("Failed to update payment options: "+a.message)}}),e.querySelector("#btn-save-pin")?.addEventListener("click",()=>{const a=e.querySelector("#setting-sec-pin")?.value;a&&a.length===4?(localStorage.setItem("sl_admin_pin",a),S.success("Admin 4-digit PIN lock saved successfully!")):S.error("Please enter a valid 4-digit PIN.")}),e.querySelector("#btn-sec-export-json")?.addEventListener("click",()=>{e.querySelector("#btn-master-quick-backup")?.click()}),e.querySelector("#btn-add-staff-member")?.addEventListener("click",()=>{fe(e,o.branches||[])}),e.querySelector("#btn-refresh-ai-insights")?.addEventListener("click",()=>{S.info("Refreshing retention and revenue intelligence...");const a=e.querySelector("#master-studio-viewport");a&&(a.innerHTML="",a.appendChild(Y(o.settings.auto)),J(e,"automations_ai",o))}),e.querySelector("#btn-run-auto-reminders-now")?.addEventListener("click",async()=>{try{O.show("Executing Automated WhatsApp Expiry & Dues Dispatch Engine...");const a=await C.post("/api/messages/run-cron-now");if(O.hide(),a.success){const s=a.data||{},i=document.createElement("div");i.innerHTML=`
          ...
          <div class="row g-2 mb-3">
            <div class="col-6">
              <div class="p-2 rounded border text-center" style="background: var(--color-bg-secondary);">
                <div style="font-size: 1.3rem; font-weight: 800; color: var(--color-primary);">${s.totalStudentsScanned??0}</div>
                <div class="small text-muted font-weight-bold">Students Scanned</div>
              </div>
            </div>
            <div class="col-6">
              <div class="p-2 rounded border text-center" style="background: var(--color-bg-secondary);">
                <div style="font-size: 1.3rem; font-weight: 800; color: var(--color-success);">${s.expiryRemindersSent??0}</div>
                <div class="small text-muted font-weight-bold">Expiry Alerts Dispatched</div>
              </div>
            </div>
            <div class="col-6">
              <div class="p-2 rounded border text-center" style="background: var(--color-bg-secondary);">
                <div style="font-size: 1.3rem; font-weight: 800; color: var(--color-warning);">${s.balanceDueRemindersSent??0}</div>
                <div class="small text-muted font-weight-bold">Dues Alerts Dispatched</div>
              </div>
            </div>
            <div class="col-6">
              <div class="p-2 rounded border text-center" style="background: var(--color-bg-secondary);">
                <div style="font-size: 1.3rem; font-weight: 800; color: var(--color-danger);">${s.seatsReleased??0}</div>
          ...
          ${s.logs&&s.logs.length>0?`
            <div style="max-height: 180px; overflow-y: auto; font-size: 0.78rem; background: var(--color-surface); padding: 8px; border-radius: 6px; border: 1px solid var(--color-border);">
              <div class="font-weight-bold mb-1 text-muted">Execution Logs (${s.logs.length}):</div>
              ${s.logs.map(r=>`<div class="py-1 border-bottom d-flex justify-content-between"><span><strong>${u(r.studentName)}</strong> (${r.type}): ${u(r.detail||r.timeLabel||"")}</span><span class="badge badge-success">${r.status}</span></div>`).join("")}
            </div>
          `:'<div class="text-muted small text-center">No active student subscriptions required immediate reminder alerts today.</div>'}
        `,new V({title:"\u{1F916} Automated Reminders Execution Report",content:i,size:"md"}).show()}else S.error(a.message||"Failed to execute automated reminders bot")}catch(a){O.hide(),S.error(a.message||"Error executing automated reminders")}});const v=e.querySelector("#setting-notif-provider");if(v){const a=()=>{const s=v.value;e.querySelectorAll(".wa-provider-field").forEach(i=>i.style.display="none"),s==="ultramsg"?e.querySelectorAll(".wa-field-ultramsg").forEach(i=>i.style.display="block"):s==="fast2sms"?e.querySelectorAll(".wa-field-fast2sms").forEach(i=>i.style.display="block"):s==="meta"?e.querySelectorAll(".wa-field-meta").forEach(i=>i.style.display="block"):s==="webhook"&&e.querySelectorAll(".wa-field-webhook").forEach(i=>i.style.display="block")};v.addEventListener("change",a)}e.querySelector("#btn-test-wa-gateway")?.addEventListener("click",async()=>{const a=e.querySelector("#btn-test-wa-gateway");try{O.button(a,!0);const s=await C.post("/api/notifications/test-gateway",{type:"whatsapp",message:"\u{1F680} Test alert from Study Library Management System: Your WhatsApp Gateway integration is working perfectly!"});O.button(a,!1),s.success?(S.success(s.message||"Test message dispatched to gateway!"),s.data?.whatsappUrl&&(!s.data?.provider||s.data?.provider==="click_to_chat")&&window.open(s.data.whatsappUrl,"_blank")):S.error(s.message||"Gateway test failed")}catch(s){O.button(a,!1),S.error(s.message||"Test dispatch failed")}}),m==="system_health"&&ye(e)}function be(){return`
    <div class="card" style="padding: 1.5rem; background: var(--color-surface); border: 1px solid var(--color-border); border-radius: var(--radius-lg);">
  ...
  `}function ye(e){let m=null;async function o(v=!1){try{const a=localStorage.getItem("sl_token")||localStorage.getItem("token")||"",s=await(await fetch("/api/health")).json();if(s){const r=e.querySelector("#health-val-uptime");r&&(r.textContent=s.uptimeFormatted||`${s.uptime}s`);const b=e.querySelector("#health-val-node");b&&(b.textContent=`${s.system?.nodeVersion||"Node.js"} (PID: ${s.system?.pid||"-"})`);const n=e.querySelector("#health-val-dbping");if(n){const k=s.database?.pingLatencyMs;n.textContent=k>=0?`${k} ms`:"Connected",n.style.color=k>=0&&k>350?"var(--color-warning)":"var(--color-primary)"}const l=e.querySelector("#health-val-dbhost");l&&s.database?.host&&(l.textContent=s.database.host.split(".")[0]||"Atlas Cloud");const f=e.querySelector("#health-val-memory");f&&s.memory&&(f.textContent=`${s.memory.heapUsedMB} MB / ${s.memory.containerLimitMB} MB`);const E=e.querySelector("#health-val-rss");E&&s.memory&&(E.textContent=`RSS: ${s.memory.rssMB} MB (${s.memory.usagePercent}%)`);const $=e.querySelector("#health-memory-bar");if($&&s.memory){const k=Math.min(100,Math.max(5,s.memory.usagePercent||15));$.style.width=`${k}%`,$.className=`progress-bar ${k>80?"bg-danger":k>60?"bg-warning":"bg-success"}`}}const i=await(await fetch("/api/system/health-check",{headers:{Authorization:`Bearer ${a}`}})).json();if(i.success&&i.data){m=i.data;const r=i.data,b=e.querySelector("#health-pipeline-container");if(b&&Array.isArray(r.dataPipelineAudit?.pipelineSteps)){const l=r.dataPipelineAudit.pipelineSteps;b.innerHTML=l.map(f=>{const E=f.status==="pass",$=E?"badge-success":"badge-danger";return`
  ...
  `;const a=new V({title:"\u{1F465} Add Staff Team Member",content:o,size:"md"});a.show(),o.querySelector("#form-add-staff")?.addEventListener("submit",async s=>{s.preventDefault();const i=o.querySelector("#staff-name").value.trim(),r=o.querySelector("#staff-email").value.trim(),b=o.querySelector("#staff-password").value,n=o.querySelector("#staff-phone").value.trim(),l=o.querySelector("#staff-role").value,f=o.querySelector("#staff-branch").value||null;try{await C.post("/api/auth/users",{name:i,email:r,password:b,phone:n,role:l,branch:f}),S.success("Staff account created successfully!"),a.close(),G(e)}catch(E){S.error(E.message||"Failed to create staff account")}})}async function Fe(e,m,o){const v=[e.querySelector("#btn-master-save-all"),e.querySelector("#btn-master-save-all-mobile")].filter(Boolean);v.forEach(a=>O.button(a,!0));try{const a=[],s=(t,y)=>{const A=e.querySelector(t);return A?A.value.trim():y??""},i=(t,y)=>{const A=e.querySelector(t);return A&&A.value!==""?Number(A.value):y??0},r=(t,y)=>{const A=e.querySelector(t);return A?A.checked:!!y},b={...o.profile,businessName:s("#setting-businessName",o.profile.businessName),tagline:s("#setting-tagline",o.profile.tagline),phone:s("#setting-phone",o.profile.phone),email:s("#setting-email",o.profile.email),website:s("#setting-website",o.profile.website),address:s("#setting-address",o.profile.address),city:s("#setting-city",o.profile.city),state:s("#setting-state",o.profile.state),pincode:s("#setting-pincode",o.profile.pincode),registrationNumber:s("#setting-regNumber",o.profile.registrationNumber),gstNumber:s("#setting-gstNumber",o.profile.gstNumber),logo:(e.querySelector("#setting-logo")||e.querySelector('input[name="logo"]'))?.value?.trim()||o.profile.logo,favicon:(e.querySelector("#setting-favicon")||e.querySelector('input[name="favicon"]'))?.value?.trim()||o.profile.favicon,stampImage:(e.querySelector("#setting-stamp")||e.querySelector('input[name="stampImage"]'))?.value?.trim()||o.profile.stampImage,bannerImage:(e.querySelector("#setting-banner")||e.querySelector('input[name="bannerImage"]'))?.value?.trim()||o.profile.bannerImage,upiId:s("#setting-bill-upiId",o.profile.upiId),upiQrCode:(e.querySelector("#setting-bill-upiQr")||e.querySelector('input[name="upiQrCode"]'))?.value?.trim()||o.profile.upiQrCode,bankDetails:{...o.profile.bankDetails||{},accountName:s("#setting-bank-accName",o.profile.bankDetails?.accountName),accountNumber:s("#setting-bank-accNo",o.profile.bankDetails?.accountNumber),bankName:s("#setting-bank-name",o.profile.bankDetails?.bankName),ifscCode:s("#setting-bank-ifsc",o.profile.bankDetails?.ifscCode),branchName:s("#setting-bank-branch",o.profile.bankDetails?.branchName)},paymentInstructions:s("#setting-pay-instructions",o.profile.paymentInstructions),gatewayProvider:e.querySelector("#setting-gateway-provider")?.value||o.profile.gatewayProvider||"manual_upi",razorpayKeyId:s("#setting-razorpay-key",o.profile.razorpayKeyId),socialLinks:{...o.profile.socialLinks||{},whatsapp:s("#setting-social-wa",o.profile.socialLinks?.whatsapp),instagram:s("#setting-social-insta",o.profile.socialLinks?.instagram),facebook:s("#setting-social-fb",o.profile.socialLinks?.facebook)}},n=e.querySelectorAll(".setting-paymethod-row");n.length>0&&(b.paymentMethods=Array.from(n).map((t,y)=>({key:t.dataset.key,name:t.querySelector(".spm-name")?.value?.trim()||t.dataset.name,subtitle:t.querySelector(".spm-sub")?.value?.trim()||"",icon:t.dataset.icon||"\u{1F4B3}",enabled:t.querySelector(".spm-enabled")?t.querySelector(".spm-enabled").checked:!0,order:y+1,instructions:t.querySelector(".spm-instructions")?.value?.trim()||"",requiresRef:t.querySelector(".spm-reqref")?t.querySelector(".spm-reqref").checked:!0,refLabel:t.querySelector(".spm-reflabel")?.value?.trim()||"Transaction Reference / UTR *"})));const l={payment:{gracePeriod:i("#setting-pay-grace",o.settings.pay?.gracePeriod??5),lateFeeAmount:i("#setting-pay-lateFee",o.settings.pay?.lateFeeAmount??50),autoSuspendDays:i("#setting-pay-suspend",o.settings.pay?.autoSuspendDays??15)},locker:{enableAddon:r("#setting-locker-enable",o.settings.locker?.enableAddon!==!1),monthlyFee:i("#setting-locker-fee",o.settings.locker?.monthlyFee??200),deposit:i("#setting-locker-deposit",o.settings.locker?.deposit??0),title:s("#setting-locker-title",o.settings.locker?.title||"Add Personal Study Locker"),description:s("#setting-locker-desc",o.settings.locker?.description||"Secure private key-allotted locker to safely keep heavy study books, notes & laptop.")},admission:{idPrefix:s("#setting-adm-idPrefix",o.settings.adm?.idPrefix||"STU")},billing:{receiptPrefix:s("#setting-bill-prefix",o.settings.billing?.receiptPrefix||"LIB-2026"),defaultTemplate:e.querySelector(".receipt-format-card.active")?.dataset.format||o.settings.billing?.defaultTemplate||"thermal80",gstRate:i("#setting-bill-gstRate",o.settings.billing?.gstRate??18),hsnSacCode:s("#setting-bill-hsn",o.settings.billing?.hsnSacCode||"999293"),refundPolicyDays:i("#setting-bill-refundDays",o.settings.billing?.refundPolicyDays??3)},notification:{enableWhatsapp:r("#setting-notif-wa",o.settings.notif?.enableWhatsapp??!0),whatsappScheduleTime:s("#setting-notif-time",o.settings.notif?.whatsappScheduleTime||"09:30"),expiryReminderDays:s("#setting-notif-expiryDays",o.settings.notif?.expiryReminderDays||"7, 3, 1, 0"),balanceReminderDays:s("#setting-notif-balanceDays",o.settings.notif?.balanceReminderDays||"7, 3, 1"),enableAutoExpiryBot:r("#setting-notif-expiryBot",o.settings.notif?.enableAutoExpiryBot!==!1),enableAutoDuesBot:r("#setting-notif-duesBot",o.settings.notif?.enableAutoDuesBot!==!1),enableConversationalBot:r("#setting-notif-chatBot",o.settings.notif?.enableConversationalBot!==!1),whatsappProvider:s("#setting-notif-provider",o.settings.notif?.whatsappProvider||"none"),ultramsgInstanceId:s("#setting-notif-ultramsgId",o.settings.notif?.ultramsgInstanceId||""),ultramsgToken:s("#setting-notif-ultramsgToken",o.settings.notif?.ultramsgToken||""),fast2smsApiKey:s("#setting-notif-fast2smsKey",o.settings.notif?.fast2smsApiKey||""),metaPhoneNumberId:s("#setting-notif-metaPhoneId",o.settings.notif?.metaPhoneNumberId||""),metaAccessToken:s("#setting-notif-metaToken",o.settings.notif?.metaAccessToken||""),webhookUrl:s("#setting-notif-webhookUrl",o.settings.notif?.webhookUrl||"")},operations:{openingTime:s("#setting-ops-open",o.settings.ops?.openingTime||"06:00"),closingTime:s("#setting-ops-close",o.settings.ops?.closingTime||"23:00"),weeklyOff:s("#setting-ops-weeklyOff",o.settings.ops?.weeklyOff||"none"),autoCheckout:r("#setting-ops-autoCheckout",o.settings.ops?.autoCheckout!==!1),autoCheckoutHours:i("#setting-ops-autoCheckoutHours",Number(o.settings.ops?.autoCheckoutHours)||16),autoCheckoutTime:s("#setting-ops-autoCheckoutTime",o.settings.ops?.autoCheckoutTime||"23:00"),gracePeriodMinutes:i("#setting-ops-graceMinutes",Number(o.settings.ops?.gracePeriodMinutes)||15),latePenaltyPerHour:i("#setting-ops-overstayPenalty",Number(o.settings.ops?.latePenaltyPerHour)||0),examExtendedHours:r("#setting-ops-examHours",!!o.settings.ops?.examExtendedHours),emergencyNotice:s("#setting-ops-emergencyNotice",o.settings.ops?.emergencyNotice||""),emergencyNoticeEnabled:r("#setting-ops-emergencyToggle",!!o.settings.ops?.emergencyNoticeEnabled)},kiosk:{enableVoice:r("#setting-kiosk-voice",o.settings.kiosk?.enableVoice!==!1),voiceLanguage:s("#setting-kiosk-lang",o.settings.kiosk?.voiceLanguage||"en-IN"),soundEnabled:r("#setting-kiosk-sound",o.settings.kiosk?.soundEnabled!==!1),autoCheckout:r("#setting-kiosk-autoCheckout",o.settings.kiosk?.autoCheckout!==!1),autoCheckoutHours:i("#setting-kiosk-checkoutHours",Number(o.settings.kiosk?.autoCheckoutHours)||16),screenTimeoutSeconds:i("#setting-kiosk-timeout",Number(o.settings.kiosk?.screenTimeoutSeconds)||10),announcementVolume:i("#setting-kiosk-volume",Number(o.settings.kiosk?.announcementVolume)||80)},automations:{autoSeatExpiry:r("#setting-auto-seatExpiry",o.settings.auto?.autoSeatExpiry!==!1),autoDueReminders:r("#setting-auto-dueReminders",o.settings.auto?.autoDueReminders!==!1)},portal:{...o.settings.portal||{}}};e.querySelectorAll(".student-portal-toggle").forEach(t=>{l.portal[t.dataset.key]=t.checked}),Object.assign(o.profile,b),Object.assign(o.settings,l),a.push(C.put("/api/settings/business-profile",b)),a.push(C.put("/api/settings/system-settings",l));try{localStorage.removeItem("sl_public_config_cache"),localStorage.removeItem("sl_public_profile_cache")}catch{}const f=e.querySelector("#branding-headerText")?.value?.trim(),E=e.querySelector("#branding-tagline")?.value?.trim(),$=e.querySelector("#branding-alignment")?.value||"center",k=e.querySelector("#branding-logoSize")?.value||"64";(f||E)&&a.push(C.put("/api/custom-fields/templates/active",{branding:{headerText:f||"Student Admission Wizard",tagline:E||"Silence, Focus & Success",alignment:$,logoSize:k,showLogo:!0}}).catch(t=>console.warn("FormTemplate save warning:",t.message)));const I=e.querySelector("#rc-header-subtitle"),D=e.querySelector("#rc-toggle-paymentMode");if(I||D||e.querySelector("#rc-toggle-stuId")){const t=e.querySelector(".receipt-format-card.active")?.dataset.format||o.settings.billing?.defaultTemplate||"thermal80",y=e.querySelector("#rc-header-gstin")?.value?.trim(),A={activeTemplate:t,header:{showLogo:e.querySelector("#rc-toggle-logo")?e.querySelector("#rc-toggle-logo").checked:!0,showBusinessName:!0,subtitle:e.querySelector("#rc-header-subtitle")?.value?.trim()||"Official Fee Receipt",showAddress:e.querySelector("#rc-toggle-address")?e.querySelector("#rc-toggle-address").checked:!0,showPhone:e.querySelector("#rc-toggle-contact")?e.querySelector("#rc-toggle-contact").checked:!0,showEmail:e.querySelector("#rc-toggle-contact")?e.querySelector("#rc-toggle-contact").checked:!0,showGst:!!y,gstNumber:y,headerColor:e.querySelector("#rc-header-color")?.value||"#4f46e5"},body:{showStudentId:e.querySelector("#rc-toggle-stuId")?e.querySelector("#rc-toggle-stuId").checked:!0,showStudentPhone:e.querySelector("#rc-toggle-stuPhone")?e.querySelector("#rc-toggle-stuPhone").checked:!0,showSeatNumber:e.querySelector("#rc-toggle-seat")?e.querySelector("#rc-toggle-seat").checked:!0,showShift:e.querySelector("#rc-toggle-seat")?e.querySelector("#rc-toggle-seat").checked:!0,showPeriod:e.querySelector("#rc-toggle-validity")?e.querySelector("#rc-toggle-validity").checked:!0,showDiscount:e.querySelector("#rc-toggle-breakdown")?e.querySelector("#rc-toggle-breakdown").checked:!0,showPaymentMethod:e.querySelector("#rc-toggle-paymentMode")?e.querySelector("#rc-toggle-paymentMode").checked:!0,showTransactionId:e.querySelector("#rc-toggle-paymentMode")?e.querySelector("#rc-toggle-paymentMode").checked:!0},stamp:{showStamp:e.querySelector("#rc-toggle-stamp")?e.querySelector("#rc-toggle-stamp").checked:!0,stampText:e.querySelector("#rc-stamp-text")?.value?.trim()||"PAID \u2022 OFFICIAL RECEIPT",stampColor:e.querySelector("#rc-stamp-color")?.value||"#059669",showWatermark:t==="standardA4"},footer:{showSignature:e.querySelector("#rc-toggle-signature")?e.querySelector("#rc-toggle-signature").checked:!0,signatureLabel:e.querySelector("#rc-signature-label")?.value?.trim()||"Authorized Signatory",showUpiQr:e.querySelector("#rc-toggle-upiqr")?e.querySelector("#rc-toggle-upiqr").checked:!0,termsText:e.querySelector("#rc-terms-text")?.value?.trim(),customNote:e.querySelector("#rc-custom-note")?.value?.trim(),showTimestamp:e.querySelector("#rc-toggle-timestamp")?e.querySelector("#rc-toggle-timestamp").checked:!0},gst:{enabled:Number(e.querySelector("#setting-bill-gstRate")?.value||18)>0,gstRate:Number(e.querySelector("#setting-bill-gstRate")?.value||18),hsnCode:e.querySelector("#setting-bill-hsn")?.value?.trim()||"999293"}};o.settings&&(o.settings.receipt=A),a.push(C.put("/api/settings/receipt-config",A))}const H=await Promise.all(a),z=H[0]||{},x=H[1]||{};if(z.success||x.success){S.success("Master Settings updated successfully across all modules!");const t=z.data||b;window.ThemeManager&&typeof window.ThemeManager.applyPublicBranding=="function"&&window.ThemeManager.applyPublicBranding(t);try{localStorage.setItem("sl_public_profile_cache",JSON.stringify(t)),localStorage.setItem("sl_settings_sync_trigger",Date.now().toString()),window.dispatchEvent(new CustomEvent("sl:settings-updated",{detail:{profile:t,settings:l}}))}catch{}typeof window.updateDynamicFaviconAndTitle=="function"&&t&&window.updateDynamicFaviconAndTitle(t)}else S.error("Settings updated with warnings.")}catch(a){S.error(a.message||"Failed to save settings.")}finally{v.forEach(a=>O.button(a,!1))}}export{G as render};
