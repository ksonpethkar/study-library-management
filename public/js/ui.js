import{AudioFeedback as M}from"./utils/audioFeedback.js";import{triggerHaptic as P}from"./utils/mobileGestures.js";function h(e){return e==null?"":String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}typeof window<"u"&&(window.escapeHTML=h);const x={show(e,t="info",o=4e3){let n=document.getElementById("toast-container");n||(n=document.createElement("div"),n.id="toast-container",n.className="toast-container",document.body.appendChild(n)),t==="success"?(M.play("success"),P("success")):t==="warning"||t==="error"?(M.play("warning"),P("warning")):P("light");const i=document.createElement("div");i.className=`toast toast-${t}`;let a="";t==="success"?a='<svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"></polyline></svg>':t==="error"?a='<svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"></circle><line x1="15" y1="9" x2="9" y2="15"></line><line x1="9" y1="9" x2="15" y2="15"></line></svg>':t==="warning"?a='<svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2"><path d="M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"></path><line x1="12" y1="9" x2="12" y2="13"></line><line x1="12" y1="17" x2="12.01" y2="17"></line></svg>':a='<svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="16" x2="12" y2="12"></line><line x1="12" y1="8" x2="12.01" y2="8"></line></svg>',i.innerHTML=`
    ...
    `,n.appendChild(i);const r=i.querySelector(".toast-close"),p=()=>{i.style.opacity="0",i.style.transform="translateX(20px)",setTimeout(()=>i.remove(),250)};r.onclick=p,o>0&&setTimeout(p,o)},success(e){this.show(e,"success")},error(e){this.show(e,"error")},warning(e){this.show(e,"warning")},info(e){this.show(e,"info")},undo(e,t){let o=document.getElementById("toast-container");o||(o=document.createElement("div"),o.id="toast-container",o.className="toast-container",document.body.appendChild(o)),M.play("info");const n=document.createElement("div");n.className="toast toast-info toast-undo";const i='<svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="16" x2="12" y2="12"></line><line x1="12" y1="8" x2="12.01" y2="8"></line></svg>';n.innerHTML=`
    ...
    `,o.appendChild(n);let a=!1,r=null;const p=()=>{a||(a=!0,r&&clearTimeout(r),n.style.opacity="0",n.style.transform="translateX(20px)",setTimeout(()=>n.remove(),250))},u=n.querySelector(".toast-undo-btn");u&&(u.onclick=()=>{a||(p(),typeof t=="function"&&t())});const s=n.querySelector(".toast-close");s&&(s.onclick=p),r=setTimeout(p,5e3)}};class H{constructor(t,o,n="md"){typeof t=="object"&&t!==null?this.options=t:this.options={title:t,content:o,size:n},this.element=null}show(){return this.element=d.show(this.options),this.element}open(){return this.show()}hide(){d.close(this.element)}close(){d.close(this.element)}}const d=function(e,t,o){return new.target||this instanceof d?(typeof e=="object"&&e!==null?this.options=e:this.options={title:e,content:t,size:o},this.element=null,this):new H(e,t,o)};d._stack=[],d.show=function(e){let t="",o="",n="md",i="",a=null,r=null;typeof e=="string"?t=e:typeof e=="object"&&e!==null&&(t=e.title||"",o=e.content||"",n=e.size||"md",i=e.actions||"",a=e.buttons||null,r=e.onClose||null);const p=d._stack.length,u=1e3+p*10;if(p>0){const y=d._stack[p-1];y&&y.element&&(y.element.setAttribute("aria-hidden","true"),y.element.style.pointerEvents="none")}const s=document.createElement("dialog");s.className="modal-container-dialog app-modal modal",s.id=p===0?"modal-container":`modal-container-${Date.now()}-${p}`,s.setAttribute("data-stack-level",String(p));const l={sm:"420px",md:"640px",lg:"850px",xl:"1050px"},c=l[n]||l.md;s.style.cssText=`
    padding: 0;
  ...
  `,s.innerHTML=`
    <div class="modal-header" style="padding: 14px 20px; border-bottom: 1px solid var(--color-divider, rgba(255,255,255,0.08)); display: flex; justify-content: space-between; align-items: center; flex-shrink: 0;">
      <h3 style="margin: 0; font-size: 1.15rem; font-weight: 700; color: var(--color-text-primary, #fff);">${h(t)}</h3>
  ...
  `;const m=s.querySelector(".modal-body-container");o instanceof HTMLElement?m.appendChild(o):typeof o=="string"&&(m.innerHTML=o);const g=s.querySelector(".modal-footer-container"),v={element:s,close:()=>{d.close(s)},hide:()=>{d.close(s)}};if(a&&Array.isArray(a)&&a.length>0)g.style.display="flex",a.forEach(y=>{const b=document.createElement("button");b.type="button",b.className=`btn ${y.className||"btn-secondary"}`,b.textContent=y.text||"Button",b.onclick=L=>{L.preventDefault(),L.stopPropagation(),typeof y.onClick=="function"?y.onClick(v):d.close(s)},g.appendChild(b)});else if(e&&(e.onConfirm||e.confirmText)){g.style.display="flex";const y=document.createElement("button");y.type="button",y.className="btn btn-secondary modal-cancel-btn",y.textContent=e.cancelText||"Cancel",y.onclick=L=>{L.preventDefault(),L.stopPropagation(),d.close(s)};const b=document.createElement("button");b.type="button",b.className=`btn ${e.confirmClass||"btn-primary"} modal-confirm-btn`,b.textContent=e.confirmText||"Save & Confirm",b.onclick=async L=>{if(L.preventDefault(),L.stopPropagation(),typeof e.onConfirm=="function"){b.disabled=!0,b.textContent="Processing...";try{await e.onConfirm(v)!==!1?d.close(s):(b.disabled=!1,b.textContent=e.confirmText||"Save & Confirm")}catch(G){console.error(G),d.close(s)}}else d.close(s)},g.appendChild(y),g.appendChild(b)}else i&&(g.style.display="flex",g.innerHTML=i);const f=s.querySelector(".modal-close"),_=y=>{y&&(y.preventDefault(),y.stopPropagation()),d.close(s)};if(f&&(f.onclick=_),s.oncancel=y=>{y.preventDefault(),y.stopPropagation()},s.addEventListener("cancel",y=>{y.preventDefault(),y.stopPropagation()}),e&&e.backdropClose===!0){let y=!1;s.addEventListener("mousedown",b=>{y=b.target===s}),s.addEventListener("mouseup",b=>{y&&b.target===s&&d.close(s),y=!1})}if(d._stack.push({element:s,onClose:r,options:e,wrapper:v}),document.body.appendChild(s),typeof document<"u"&&document.body&&(document.body.classList.add("modal-open"),document.body.style.overflow="hidden"),typeof s.showModal=="function"){if(!s.open)try{s.showModal()}catch{s.setAttribute("open",""),s.style.display="flex"}}else s.setAttribute("open",""),s.style.display="flex";return s},d.close=function(e){if(!d._stack||d._stack.length===0){document.querySelectorAll("dialog, #modal-container, .modal-container, .modal, .modal-backdrop").forEach(o=>{try{typeof o.close=="function"&&o.open&&o.close(),o.removeAttribute("open"),o.style.display="none",o.remove()}catch{}}),typeof document<"u"&&document.body&&(document.body.classList.remove("modal-open"),document.body.style.overflow="");return}let t=null;if(e){const o=e instanceof HTMLElement?e:e&&e.element?e.element:null,n=d._stack.findIndex(i=>i.element===o||o&&i.element&&i.element.contains(o));n!==-1&&(t=d._stack.splice(n,1)[0])}if(t||(t=d._stack.pop()),t&&t.element){try{typeof t.element.close=="function"&&t.element.open&&t.element.close()}catch{}try{t.element.removeAttribute("open"),t.element.style.display="none",t.element.remove()}catch{}if(typeof t.onClose=="function")try{t.onClose()}catch(o){console.error("Error in Modal onClose handler:",o)}}if(d._stack.length>0){const o=d._stack[d._stack.length-1];if(o&&o.element){o.element.removeAttribute("aria-hidden"),o.element.style.pointerEvents="";try{const n=o.element.querySelector('input:not([disabled]), select:not([disabled]), textarea:not([disabled]), button:not([disabled]), [tabindex]:not([tabindex="-1"])');n?n.focus():o.element.focus()}catch{}}}else typeof document<"u"&&document.body&&(document.body.classList.remove("modal-open"),document.body.style.overflow=""),document.querySelectorAll(".modal-backdrop").forEach(o=>{try{o.remove()}catch{}})},d.closeAll=function(){if(d._stack&&d._stack.length>0)for(;d._stack.length>0;)d.close();document.querySelectorAll("dialog, #modal-container, .modal-container, .modal, .modal-backdrop").forEach(e=>{try{typeof e.close=="function"&&e.open&&e.close(),e.removeAttribute("open"),e.style.display="none",e.remove()}catch{}}),typeof document<"u"&&document.body&&(document.body.classList.remove("modal-open"),document.body.style.overflow="")},d.hide=function(e){d.close(e)},typeof document<"u"&&document.addEventListener("click",e=>{const t=e.target.closest("[data-modal-close], [data-close-modal], .modal-close, .modal-close-btn, .modal-cancel, .btn-modal-close, .fb-cancel-modal-btn");if(t){e.preventDefault(),e.stopPropagation();const n=t.closest("dialog, .modal-container, .modal");if(n){d.close(n);return}d.close();return}const o=e.target.closest(".modal-cancel-btn");if(o){e.preventDefault(),e.stopPropagation();const n=o.closest("dialog, .modal-container, .modal");if(n){d.close(n);return}d.close()}},!0);const q={printElement(e,t="Document"){const o=document.getElementById(e);if(!o){x.error("Element not found for export");return}const n=window.open("","_blank","width=800,height=900");if(!n){window.print();return}n.document.write(`
      <!DOCTYPE html>
      <html>
      <head>
        <title>${h(t)}</title>
    ...
    `),n.document.close()}};d.prototype.show=function(){return this.element=d.show(this.options),this.element},d.prototype.open=function(){return this.show()},d.prototype.hide=function(){d.close(this.element)},d.prototype.close=function(){d.close(this.element)},d.confirm=async function(e,t,o){return typeof e=="string"&&typeof t=="string"?await E.show({title:e,message:t,confirmText:o?.confirmLabel||o?.confirmText||"Confirm",danger:o?.confirmClass?.includes("danger")||o?.danger||!1}):typeof e=="string"?await E.show({message:e,confirmText:t?.confirmLabel||t?.confirmText||"Confirm",danger:t?.confirmClass?.includes("danger")||t?.danger||!1}):await E.show(e)};const E=function(e,t){return typeof e=="string"?E.show({title:"Confirmation",message:e,onConfirm:t}):E.show(e)};E.show=async function(e){let t="Confirm Action",o="Are you sure?",n="Confirm",i="Cancel",a=!1,r=null;typeof e=="string"?o=e:typeof e=="object"&&e!==null&&(t=e.title||t,o=e.message||o,n=e.confirmText||n,i=e.cancelText||i,a=e.danger||!1,r=e.onConfirm||null);const p=a?"\u26A0\uFE0F":"\u2753";return new Promise(u=>{let s=!1;const l=g=>{s||(s=!0,d.close(),u(g))},c=a?"btn-danger":"btn-primary",m=`
    ...
    `;d.show({title:t,content:m,size:"sm",buttons:[{text:i,className:"btn-secondary modal-cancel-btn",onClick:()=>{l(!1)}},{text:n,className:`${c} modal-confirm-btn`,onClick:async()=>{if(l(!0),typeof r=="function")try{await r()}catch(g){console.error("onConfirm error:",g)}}}],onClose:()=>l(!1)})})};const B={_progressInterval:null,_progressValue:0,startProgress(){let e=document.getElementById("global-top-progress");e||(e=document.createElement("div"),e.id="global-top-progress",e.className="global-top-progress-bar",document.body.appendChild(e)),clearInterval(this._progressInterval),this._progressValue=15,e.style.width="15%",e.style.opacity="1",e.style.display="block",this._progressInterval=setInterval(()=>{this._progressValue<85&&(this._progressValue+=Math.random()*12,this._progressValue>85&&(this._progressValue=85),e.style.width=`${this._progressValue}%`)},100)},doneProgress(){clearInterval(this._progressInterval);const e=document.getElementById("global-top-progress");e&&(e.style.width="100%",setTimeout(()=>{e.style.opacity="0",setTimeout(()=>{e.style.display="none",e.style.width="0%"},250)},150))},showPage(e="Loading...",t="Preparing your workspace...",o="\u26A1"){this.startProgress();const n=document.getElementById("system-preloader");if(n&&n.style.display!=="none"){const a=document.getElementById("sys-preloader-icon"),r=document.getElementById("sys-preloader-name"),p=document.getElementById("sys-preloader-sub");a&&(a.textContent=o),r&&(r.textContent=e),p&&(p.textContent=t);return}let i=document.getElementById("global-page-loader");i||(i=document.createElement("div"),i.id="global-page-loader",i.className="global-page-loader-overlay",document.body.appendChild(i)),i.innerHTML=`
      <div class="page-loader-card">
        <div class="page-loader-ring">
          <span class="page-loader-icon">${o}</span>
        </div>
        <h3 class="page-loader-title">${h(e)}</h3>
        <p class="page-loader-subtitle">${h(t)}</p>
        <div class="page-loader-bar">
          <div class="page-loader-progress"></div>
        </div>
      </div>
    `,i.style.opacity="1",i.style.visibility="visible",i.style.display="flex"},hidePage(){this.doneProgress();const e=document.getElementById("system-preloader");e&&(e.style.opacity="0",e.style.pointerEvents="none",setTimeout(()=>{e.style.display="none";try{e.remove()}catch{}},250));const t=document.getElementById("global-page-loader");t&&(t.style.opacity="0",t.style.pointerEvents="none",setTimeout(()=>{t.style.display="none";try{t.remove()}catch{}},250))},renderSkeleton(e,t="table"){e&&(typeof e=="string"&&(e=document.querySelector(e)),e&&(t==="dashboard"?e.innerHTML=`
      ...
      `))},show(e){if(!e){this.showPage("Processing Request...","Please wait a moment...","\u26A1");return}if(e instanceof HTMLElement){if(e.tagName==="BUTTON"||e.classList.contains("btn")){e.classList.add("btn-loading"),e.disabled=!0;return}e.classList.add("loading-skeleton"),e.setAttribute("aria-busy","true");return}typeof e=="string"&&this.showPage("Processing...",e,"\u26A1")},hide(e){if(this.hidePage(),e instanceof HTMLElement){if(e.tagName==="BUTTON"||e.classList.contains("btn")){e.classList.remove("btn-loading"),e.disabled=!1;return}e.classList.remove("loading-skeleton"),e.removeAttribute("aria-busy")}if(typeof e=="string")try{const o=document.querySelector(e);o&&(o.classList.remove("loading-skeleton"),o.removeAttribute("aria-busy"))}catch{}const t=document.getElementById("global-loading-overlay");t&&t.remove()},button(e,t){typeof e=="string"&&(e=document.querySelector(e)),e&&(t?(e.dataset.originalText=e.innerHTML,e.classList.add("btn-loading"),e.disabled=!0):(e.classList.remove("btn-loading"),e.dataset.originalText&&(e.innerHTML=e.dataset.originalText),e.disabled=!1))},skeleton(e,t="table"){let o=e;if(typeof e=="string"&&(o=document.querySelector(e)),!o)return;let n="";t==="table"?n=`
  ...
  `;let s="";typeof n=="string"&&!n.includes("<")?s=`<div style="font-size: 2.8rem; margin-bottom: 12px; line-height: 1;">${n}</div>`:typeof n=="string"&&(s=`<div style="margin-bottom: 14px; opacity: 0.85; display: inline-flex; align-items: center; justify-content: center;">${n}</div>`);let l="";if(r&&(l=`<button type="button" class="btn btn-primary empty-state-action-btn" style="margin-top: 16px; font-weight: 600;">${h(r)}</button>`),u.innerHTML=`
    ...
    ${l}
  `,r&&typeof p=="function"){const c=u.querySelector(".empty-state-action-btn");c&&(c.onclick=m=>p(m))}if(o.tagName==="TBODY"){o.innerHTML="";const c=document.createElement("tr"),m=document.createElement("td");return m.colSpan=100,m.style.padding="12px",m.appendChild(u),c.appendChild(m),o.appendChild(c),u}return o.innerHTML="",o.appendChild(u),u}function D(e,t,o){let n=typeof e=="string"?document.querySelector(e):e;if(n)if(t){if(n.dataset.isLoading==="true")return;n.dataset.isLoading="true",n.dataset.originalHtml=n.innerHTML,n.disabled=!0;const i='<span class="spinner-border spinner-border-sm" role="status" aria-hidden="true" style="display: inline-block; width: 0.9em; height: 0.9em; border: 2px solid currentColor; border-right-color: transparent; border-radius: 50%; animation: spin 0.75s linear infinite; vertical-align: text-bottom;"></span>',a=o?`<span class="btn-loading-text" style="margin-left: 6px;">${h(o)}</span>`:n.innerText?`<span class="btn-loading-text" style="margin-left: 6px;">${h(n.innerText.trim())}</span>`:"";n.innerHTML=`${i}${a}`}else n.dataset.originalHtml!==void 0&&(n.innerHTML=n.dataset.originalHtml,delete n.dataset.originalHtml),n.dataset.isLoading="false",n.disabled=!1}const F={emptyState:N,buttonLoading:D};typeof window<"u"&&(window.UI=F);function j(e,t=250){let o=null;return function(...n){const i=this;o&&clearTimeout(o),o=setTimeout(()=>{e.apply(i,n)},t)}}typeof window<"u"&&(window.debounce=j);const V={async share(e={}){let t,o,n;typeof e=="string"?n=e:{title:t,text:o,url:n}=e||{};const i={};if(t&&(i.title=t),o&&(i.text=o),n&&(i.url=n),navigator.share)try{if(!(navigator.canShare&&!navigator.canShare(i)))return await navigator.share(i),!0}catch(r){if(r.name==="AbortError")return!1}const a=n||o||t||(typeof window<"u"?window.location.href:"");try{if(navigator.clipboard&&navigator.clipboard.writeText)await navigator.clipboard.writeText(a);else if(typeof document<"u"){const r=document.createElement("textarea");r.value=a,r.style.position="fixed",r.style.opacity="0",document.body.appendChild(r),r.select(),document.execCommand("copy"),r.remove()}return x.success("Link copied to clipboard!"),!0}catch{return x.error("Failed to copy link"),!1}}};typeof window<"u"&&(window.NativeShare=V);async function Y(e,t){if(!e)return!1;try{if(navigator.clipboard&&navigator.clipboard.writeText)await navigator.clipboard.writeText(e);else if(typeof document<"u"){const o=document.createElement("textarea");o.value=e,o.style.position="fixed",o.style.opacity="0",document.body.appendChild(o),o.select(),document.execCommand("copy"),o.remove()}if(t){const o=t.innerHTML,n=t.style.backgroundColor,i=t.style.color,a=t.style.borderColor;t.innerHTML="\u2713 Copied!",t.classList.add("badge","bg-success","text-white"),t.style.backgroundColor="var(--color-success, #2ed573)",t.style.color="#ffffff",t.style.borderColor="var(--color-success, #2ed573)",t._copyTimeout&&clearTimeout(t._copyTimeout),t._copyTimeout=setTimeout(()=>{t.innerHTML=o,t.classList.remove("badge","bg-success","text-white"),t.style.backgroundColor=n,t.style.color=i,t.style.borderColor=a,delete t._copyTimeout},2e3)}return x.success("Copied to clipboard!"),!0}catch(o){return console.error("Failed to copy to clipboard:",o),x.error("Failed to copy to clipboard"),!1}}typeof window<"u"&&(window.copyToClipboard=Y);class k{constructor(t={}){typeof t=="string"&&(t={title:t}),this.options=t,this.sheet=null,this.overlay=null,this.onClose=t.onClose||null}static show(t){return typeof window<"u"&&window.innerWidth<=768?new k(t).open():d.show(t)}static close(){if(typeof document>"u")return;const t=document.querySelectorAll(".bottom-sheet");t.forEach(n=>{n.classList.remove("open"),n.style.transform="translateY(100%)"});const o=document.querySelectorAll(".bottom-sheet-overlay");o.forEach(n=>{n.classList.remove("open"),n.style.opacity="0"}),setTimeout(()=>{t.forEach(n=>n.remove()),o.forEach(n=>n.remove())},300)}open(){if(!(typeof window<"u"&&window.innerWidth<=768))return d.show(this.options);const t=typeof this.options=="string"?{title:this.options}:this.options||{},o=t.title||"",n=t.content||"";let i=document.querySelector(".bottom-sheet-overlay");i||(i=document.createElement("div"),i.className="bottom-sheet-overlay",document.body.appendChild(i)),this.overlay=i;const a=document.createElement("div");a.className="bottom-sheet",this.sheet=a;let r="";o&&(r=`
      ...
      `);let p="";t.buttons&&Array.isArray(t.buttons)&&t.buttons.length>0?p='<div class="bottom-sheet-footer" style="margin-top: 16px; display: flex; gap: 8px; justify-content: flex-end;"></div>':t.actions&&(p=`<div class="bottom-sheet-footer" style="margin-top: 16px; display: flex; gap: 8px; justify-content: flex-end;">${t.actions}</div>`),a.innerHTML=`
      <div class="bottom-sheet-handle"></div>
      ${r}
      <div class="bottom-sheet-body"></div>
      ${p}
    `;const u=a.querySelector(".bottom-sheet-body");if(n instanceof HTMLElement?u.appendChild(n):typeof n=="string"&&(u.innerHTML=n),t.buttons&&Array.isArray(t.buttons)&&t.buttons.length>0){const l=a.querySelector(".bottom-sheet-footer");t.buttons.forEach(c=>{const m=document.createElement("button");m.className=`btn ${c.className||"btn-secondary"}`,m.textContent=c.text||"Button",m.onclick=()=>{typeof c.onClick=="function"?c.onClick(this):this.close()},l.appendChild(m)})}document.body.appendChild(a);const s=a.querySelector(".bottom-sheet-close");return s&&(s.onclick=()=>this.close()),i.onclick=()=>this.close(),this._initSwipeGesture(),requestAnimationFrame(()=>{i.classList.add("open"),a.classList.add("open")}),a}close(){this.sheet&&(this.sheet.classList.remove("open"),this.sheet.style.transform="translateY(100%)"),this.overlay&&this.overlay.classList.remove("open"),setTimeout(()=>{this.sheet&&this.sheet.remove(),this.overlay&&this.overlay.remove(),typeof this.onClose=="function"&&this.onClose()},300)}_initSwipeGesture(){if(!this.sheet)return;const t=this.sheet.querySelector(".bottom-sheet-handle")||this.sheet;let o=0,n=0,i=!1;const a=u=>{this.sheet.scrollTop>0&&u.target!==t||(o=u.touches[0].clientY,i=!0,this.sheet.style.transition="none")},r=u=>{if(!i)return;n=u.touches[0].clientY;const s=n-o;s>0&&(this.sheet.style.transform=`translateY(${s}px)`)},p=()=>{i&&(i=!1,this.sheet.style.transition="transform 0.3s cubic-bezier(0.4, 0, 0.2, 1)",n-o>80?this.close():(this.sheet.style.transform="",this.sheet.classList.add("open")))};t.addEventListener("touchstart",a,{passive:!0}),this.sheet.addEventListener("touchstart",a,{passive:!0}),window.addEventListener("touchmove",r,{passive:!0}),window.addEventListener("touchend",p,{passive:!0})}}function C(){if(typeof window>"u")return;let e=document.getElementById("pull-to-refresh-spinner");e||(e=document.createElement("div"),e.id="pull-to-refresh-spinner",e.className="pull-to-refresh-spinner",e.innerHTML=`
    ...
    `,document.body.appendChild(e));let t=0,o=0,n=!1,i=!1;window.addEventListener("touchstart",a=>{window.scrollY===0&&a.touches&&a.touches.length===1&&(t=a.touches[0].clientY,n=!0,o=0)},{passive:!0}),window.addEventListener("touchmove",a=>{if(!n||i)return;if(window.scrollY>0){n=!1;return}if(!a.touches||a.touches.length===0)return;const r=a.touches[0].clientY-t;r>0&&window.scrollY===0&&(o=r,o>=70?e.classList.add("visible"):e.classList.remove("visible"))},{passive:!0}),window.addEventListener("touchend",()=>{n&&(n=!1,o>=70&&!i?(i=!0,e.classList.add("visible"),window.dispatchEvent(new HashChangeEvent("hashchange")),setTimeout(()=>{e.classList.remove("visible"),i=!1,o=0},600)):(e.classList.remove("visible"),o=0))},{passive:!0})}typeof window<"u"&&(window.BottomSheet=k,window.initPullToRefresh=C,document.readyState==="loading"?document.addEventListener("DOMContentLoaded",()=>C()):C());function I(e="admin"){const t=document.getElementById("mobile-nav");if(!t)return;t.classList.contains("mobile-bottom-nav")||t.classList.add("mobile-bottom-nav");const o=document.getElementById("mobile-more-btn"),n=document.getElementById("mobile-more-overlay"),i=document.getElementById("mobile-more-sheet"),a=document.getElementById("mobile-logout-btn"),r=()=>{n&&(n.style.display="flex",requestAnimationFrame(()=>{n.classList.add("open"),i?.classList.add("open")}),document.body.style.overflow="hidden")},p=()=>{n&&(n.classList.remove("open"),i?.classList.remove("open"),document.body.style.overflow="",setTimeout(()=>{n.classList.contains("open")||(n.style.display="none")},300))};o?.addEventListener("click",c=>{if(c.preventDefault(),c.stopPropagation(),navigator.vibrate)try{navigator.vibrate(25)}catch{}n?.classList.contains("open")?p():r()}),n?.addEventListener("click",c=>{c.target===n&&p()}),document.addEventListener("keydown",c=>{c.key==="Escape"&&n?.classList.contains("open")&&p()}),n?.querySelectorAll(".mobile-more-item").forEach(c=>{c.addEventListener("click",m=>{if(navigator.vibrate)try{navigator.vibrate(25)}catch{}p()})}),a?.addEventListener("click",()=>{p(),document.getElementById("sidebar-logout-btn")?.click()||document.getElementById("logout-btn")?.click()});let u=0,s=0,l=!1;i?.addEventListener("touchstart",c=>{(c.target.closest(".mobile-more-handle, .mobile-more-title")||c.target===i)&&(u=c.touches[0].clientY,l=!0)},{passive:!0}),i?.addEventListener("touchmove",c=>{if(!l)return;s=c.touches[0].clientY;const m=s-u;m>0&&(i.style.transform=`translateY(${m}px)`)},{passive:!0}),i?.addEventListener("touchend",()=>{l&&(l=!1,s-u>80&&p(),i.style.transform="",u=0,s=0)},{passive:!0}),t.querySelectorAll(".mobile-nav-item:not(.mobile-nav-more-btn)").forEach(c=>{c.addEventListener("click",()=>{if(navigator.vibrate)try{navigator.vibrate(25)}catch{}})})}typeof window<"u"&&(window.renderMobileBottomNav=I);const z={recognition:null,isListening:!1,indicator:null,showIndicator(){if(this.hideIndicator(),!document.getElementById("voice-search-style")){const t=document.createElement("style");t.id="voice-search-style",t.textContent=`
      ...
      `,document.head.appendChild(t)}this.indicator=document.createElement("div"),this.indicator.id="voice-search-indicator",this.indicator.style.cssText=`
      position: fixed;
      bottom: 36px;
      left: 50%;
    ...
    `;const e=this.indicator.querySelector("button");e&&e.addEventListener("click",t=>{t.stopPropagation(),this.stop()}),document.body.appendChild(this.indicator)},hideIndicator(){this.indicator&&(this.indicator.remove(),this.indicator=null)},start(e,t){const o=window.SpeechRecognition||window.webkitSpeechRecognition;if(!o){x.error("Voice search is not supported in this browser."),t&&t("Speech recognition not supported");return}try{this.isListening&&this.recognition&&this.recognition.abort();const n=new o;this.recognition=n,n.continuous=!1,n.interimResults=!1,n.lang="en-US",n.onstart=()=>{this.isListening=!0,this.showIndicator()},n.onresult=i=>{if(this.isListening=!1,this.hideIndicator(),i.results&&i.results[0]&&i.results[0][0]){const a=i.results[0][0].transcript;e&&e(a)}},n.onerror=i=>{this.isListening=!1,this.hideIndicator(),console.error("Voice recognition error:",i.error),i.error!=="aborted"&&x.error(`Voice search error: ${i.error}`),t&&t(i.error)},n.onend=()=>{this.isListening=!1,this.hideIndicator()},n.start()}catch(n){this.isListening=!1,this.hideIndicator(),console.error("Failed to start voice search:",n),x.error("Failed to start voice search"),t&&t(n)}},stop(){if(this.recognition&&this.isListening){try{this.recognition.stop()}catch{}this.isListening=!1,this.hideIndicator()}}};typeof window<"u"&&(window.VoiceSearch=z);const O={_el:null,_scrollHandler:null,_outsideClickHandler:null,_lastScrollY:0,_isOpen:!1,mount(e={}){this.unmount();const{icon:t="+",label:o="Quick Actions",color:n="var(--color-primary, #6c5ce7)",actions:i=[]}=e,a=document.createElement("div");a.id="global-fab",a.className="fab-container",a.setAttribute("aria-label",o);const r=document.createElement("div");r.className="fab-speed-dial",r.setAttribute("aria-hidden","true"),i.forEach((s,l)=>{const c=document.createElement("button");c.className="fab-speed-item",c.type="button",c.setAttribute("aria-label",s.label||""),c.style.transitionDelay=`${l*45}ms`,c.innerHTML=`
        <span class="fab-speed-label">${h(s.label||"")}</span>
        <span class="fab-speed-icon">${s.icon||"\u26A1"}</span>
      `;const m=g=>{g&&(g.preventDefault(),g.stopPropagation()),this._closeSpeedDial(),typeof s.onClick=="function"&&setTimeout(()=>{try{s.onClick()}catch(v){console.error("Error executing FAB action:",v)}},50),typeof navigator<"u"&&navigator.vibrate&&navigator.vibrate(12)};c.addEventListener("click",m),r.appendChild(c)});const p=document.createElement("button");p.type="button",p.className="fab-main-btn",p.setAttribute("aria-expanded","false"),p.setAttribute("aria-label",o),p.style.background=n,p.innerHTML=`<span class="fab-main-icon">${t}</span>`,p.onclick=s=>{s.stopPropagation(),this._isOpen?this._closeSpeedDial():this._openSpeedDial(),typeof navigator<"u"&&navigator.vibrate&&navigator.vibrate(10)},a.appendChild(r),a.appendChild(p),document.body.appendChild(a),this._el=a,this._lastScrollY=window.scrollY;let u=!1;this._scrollHandler=()=>{u||(requestAnimationFrame(()=>{const s=window.scrollY,l=s-this._lastScrollY;l>60&&s>150?(a.classList.add("fab-hidden"),this._closeSpeedDial()):l<-20&&a.classList.remove("fab-hidden"),this._lastScrollY=s,u=!1}),u=!0)},window.addEventListener("scroll",this._scrollHandler,{passive:!0}),this._outsideClickHandler=s=>{this._isOpen&&this._el&&!this._el.contains(s.target)&&this._closeSpeedDial()},document.addEventListener("click",this._outsideClickHandler)},_openSpeedDial(){if(!this._el)return;this._isOpen=!0,this._el.classList.add("fab-open");const e=this._el.querySelector(".fab-main-btn");e&&e.setAttribute("aria-expanded","true");const t=this._el.querySelector(".fab-speed-dial");t&&t.removeAttribute("aria-hidden"),this._el.querySelectorAll(".fab-speed-item").forEach((o,n)=>{setTimeout(()=>o.classList.add("visible"),n*35)})},_closeSpeedDial(){if(!this._el)return;this._isOpen=!1,this._el.classList.remove("fab-open");const e=this._el.querySelector(".fab-main-btn");e&&e.setAttribute("aria-expanded","false");const t=this._el.querySelector(".fab-speed-dial");t&&t.setAttribute("aria-hidden","true"),this._el.querySelectorAll(".fab-speed-item").forEach(o=>o.classList.remove("visible"))},unmount(){this._el&&this._el.parentNode&&this._el.remove(),document.querySelectorAll("#global-fab, .fab-container, .speed-dial-fab").forEach(e=>e.remove()),this._el=null,this._isOpen=!1,this._scrollHandler&&(window.removeEventListener("scroll",this._scrollHandler),this._scrollHandler=null),this._outsideClickHandler&&(document.removeEventListener("click",this._outsideClickHandler),this._outsideClickHandler=null)},update(e){this.unmount(),this.mount(e)},hide(){this._el&&this._el.classList.add("fab-hidden")},show(){this._el&&this._el.classList.remove("fab-hidden")}},w={_activeFloatingMenu:null,_activeTrigger:null,closeAll(){this._activeFloatingMenu&&(this._activeFloatingMenu.remove(),this._activeFloatingMenu=null),this._activeTrigger=null,document.querySelectorAll(".dropdown.active, .dropdown.open, .dropdown-menu.show").forEach(e=>{e.classList.remove("active","open","show")})},renderHtml(e=[],t=""){const o=encodeURIComponent(JSON.stringify(e));return`
      <div class="dropdown action-menu-wrapper d-inline-block" data-entity-id="${h(t)}">
        <button type="button" class="btn-icon-action btn-action-menu-trigger dropdown-toggle" data-actions="${o}" data-entity-id="${h(t)}" aria-expanded="false" data-tooltip="More Actions" aria-label="More Actions" style="font-size: 1.15rem; font-weight: 800;">
          \u22EE
        </button>
    ...
    `},showFloatingMenu(e,t,o){if(this.closeAll(),!t||!t.length)return;const n=(s,l)=>{const c=[e.parentElement?.querySelector(`.action-menu-item[data-action="${s}"]`),e.closest(".dropdown, .action-menu-wrapper, tr, td")?.querySelector(`.action-menu-item[data-action="${s}"]`),document.querySelector(`.dropdown[data-entity-id="${l}"] .action-menu-item[data-action="${s}"]`),document.querySelector(`.action-menu-item[data-id="${l}"][data-action="${s}"]`)];for(const f of c)if(f)try{f.click();return}catch{}const m={action:s,id:l,entityId:l,trigger:e},g=new CustomEvent("action-menu-select",{bubbles:!0,cancelable:!0,detail:m});e.dispatchEvent(g),document.dispatchEvent(new CustomEvent("action-menu-select",{bubbles:!0,cancelable:!0,detail:m}));const v=e.closest("tr, .card, .portal-card, #page-content");if(v){const f=document.createElement("span");f.className="action-menu-item",f.dataset.action=s,f.dataset.id=l,f.style.display="none",v.appendChild(f);try{f.click()}finally{setTimeout(()=>f.remove(),100)}}};if(window.innerWidth<=768&&typeof k<"u"&&k.show){const s=`
    ...
    `,document.body.appendChild(i),this._activeFloatingMenu=i,this._activeTrigger=e,i.querySelectorAll(".floating-action-item").forEach(s=>{s.addEventListener("mouseenter",()=>{s.style.backgroundColor="var(--color-bg-secondary, rgba(108,92,231,0.08))"}),s.addEventListener("mouseleave",()=>{s.style.backgroundColor="transparent"})});const a=e.getBoundingClientRect(),r=i.getBoundingClientRect();let p=a.right-r.width;p<10&&(p=10),p+r.width>window.innerWidth-10&&(p=window.innerWidth-r.width-10);let u=a.bottom+4;u+r.height>window.innerHeight-10&&(u=a.top-r.height-4),i.style.left=`${Math.max(0,p)}px`,i.style.top=`${Math.max(0,u)}px`,i.addEventListener("click",s=>{const l=s.target.closest(".action-menu-item");if(!l)return;s.preventDefault(),s.stopPropagation();const c=l.dataset.action,m=l.dataset.id||o;w.closeAll(),n(c,m)})},bind(e,t){!e||typeof t!="function"||(e.addEventListener("click",o=>{const n=o.target.closest(".action-menu-item");if(!n)return;o.preventDefault(),o.stopPropagation();const i=n.dataset.action,a=n.dataset.id;t(i,a,n)}),e.addEventListener("action-menu-select",o=>{o.detail&&o.detail.action&&t(o.detail.action,o.detail.id,o.detail.trigger)}))}};typeof document<"u"&&(document.addEventListener("click",e=>{const t=e.target.closest('.btn-action-menu-trigger, [data-bs-toggle="dropdown"]');if(t){if(e.preventDefault(),e.stopPropagation(),w._activeTrigger===t){w.closeAll();return}let o=[];const n=t.getAttribute("data-actions");if(n)try{o=JSON.parse(decodeURIComponent(n))}catch{}if(!o||!o.length){const a=t.parentElement?.querySelector(".dropdown-menu");a&&a.querySelectorAll(".action-menu-item").forEach(r=>{o.push({action:r.dataset.action,id:r.dataset.id,label:r.textContent.trim(),danger:r.classList.contains("text-danger")})})}const i=t.getAttribute("data-entity-id")||t.closest("[data-entity-id]")?.dataset.entityId||"";w.showFloatingMenu(t,o,i);return}e.target.closest("#floating-action-menu-portal, #bottom-sheet, .bottom-sheet-overlay")||w.closeAll()}),window.addEventListener("resize",()=>{w._activeFloatingMenu&&!document.getElementById("bottom-sheet")&&w.closeAll()}),window.addEventListener("scroll",()=>{w._activeFloatingMenu&&w.closeAll()},{passive:!0}),document.addEventListener("keydown",e=>{e.key==="Escape"&&w.closeAll()}));function T(){if(typeof window>"u")return;const e=()=>{window.visualViewport&&(window.visualViewport.height<window.innerHeight*.75?document.body.classList.add("virtual-keyboard-open"):document.body.classList.remove("virtual-keyboard-open"))};window.visualViewport&&(window.visualViewport.addEventListener("resize",e),window.visualViewport.addEventListener("scroll",e)),window.addEventListener("focusin",t=>{t.target&&(t.target.tagName==="INPUT"||t.target.tagName==="TEXTAREA"||t.target.tagName==="SELECT")&&window.innerWidth<=768&&setTimeout(e,150)}),window.addEventListener("focusout",()=>{window.innerWidth<=768&&setTimeout(e,150)}),e()}const R={create({container:e,options:t=[],onChange:o,activeId:n=""}){if(!e)return;const i=n||t[0]?.id||"";e.innerHTML=`
